...
flowchart TD
    ...
    tiny_gift["<a class='internal-link' href='#Tiny Gift'>Tiny Gift</a>"]

    benefaction["<a class='internal-link' href='#Benefaction'>Benefaction</a>"]
    tiny_gift --> benefaction

    largess["<a class='internal-link' href='#Largess'>Largess</a>"]
    benefaction --> largess

    endowment["<a class='internal-link' href='#Endowment'>Endowment</a>"]
    largess --> endowment

    subgraph Players Guide
        conditional_blessing["<a class='internal-link' href='#Conditional Blessing'>Conditional Blessing</a>"]
    end

    benefaction --> conditional_blessing
