...
flowchart TD
    ...
    measure_the_wind["<a class='internal-link' href='#Measure the Wind'>Measure the Wind</a>"]

    stoic_endurance["<a class='internal-link' href='#Stoic Endurance'>Stoic Endurance</a>"]

    touch_of_grace["<a class='internal-link' href='#Touch of Grace'>Touch of Grace</a>"]

    sense_domain["<a class='internal-link' href='#Sense Domain'>Sense Domain</a>"]
...
flowchart TD
    ...
    dreamscape["<a class='internal-link' href='#Dreamscape'>Dreamscape</a>"]
    dreamspeak --> dreamscape

    natural_prognostication["<a class='internal-link' href='#Natural Prognostication'>Natural Prognostication</a>"]

    foretell_the_future["<a class='internal-link' href='#Foretell the Future'>Foretell the Future</a>"]
    natural_prognostication --> foretell_the_future

    hand_of_destiny["<a class='internal-link' href='#Hand of Destiny'>Hand of Destiny</a>"]
    foretell_the_future --> hand_of_destiny

    landscape_travel["<a class='internal-link' href='#Landscape Travel'>Landscape Travel</a>"]

    landscape_camouflage["<a class='internal-link' href='#Landscape Camouflage'>Landscape Camouflage</a>"]
    landscape_travel --> landscape_camouflage

    landscape_hide["<a class='internal-link' href='#Landscape Hide'>Landscape Hide</a>"]
    landscape_camouflage --> landscape_hide

    tracking["<a class='internal-link' href='#Tracking'>Tracking</a>"]

    summon_food["<a class='internal-link' href='#Summon Food'>Summon Food</a>"]
