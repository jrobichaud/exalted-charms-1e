...
flowchart TD
    ...
    subgraph Lunar
        wyld_armor["<a class='internal-link' href='#Wyld Armor'>Wyld Armor</a>"]

        wyld_shield["<a class='internal-link' href='#Wyld Shield'>Wyld Shield</a>"]

        wyld_barrier["<a class='internal-link' href='#Wyld Barrier'>Wyld Barrier</a>"]
    end
