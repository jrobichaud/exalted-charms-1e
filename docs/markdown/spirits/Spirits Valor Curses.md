...
flowchart TD
    ...
    tiny_damnation["<a class='internal-link' href='#Tiny Damnation'>Tiny Damnation</a>"]

    imprecation["<a class='internal-link' href='#Imprecation'>Imprecation</a>"]
    tiny_damnation --> imprecation

    malediction["<a class='internal-link' href='#Malediction'>Malediction</a>"]
    imprecation --> malediction

    scourge["<a class='internal-link' href='#Scourge'>Scourge</a>"]
    malediction --> scourge


    subgraph Players Guide
        conditional_curse["<a class='internal-link' href='#Conditional Curse'>Conditional Curse</a>"]
    end

    imprecation --> conditional_curse
