...
flowchart TD
    ...
    essence_bite["<a class='internal-link' href='#Essence Bite'>Essence Bite</a>"]

    materialize["<a class='internal-link' href='#Materialize'>Materialize</a>"]

    principle_of_motion["<a class='internal-link' href='#Principle of Motion'>Principle of Motion</a>"]

    words_of_power["<a class='internal-link' href='#Words of Power'>Words of Power</a>"]

    subgraph Players Guide
        dematerialize["<a class='internal-link' href='#Dematerialize'>Dematerialize</a>"]
    end
...
flowchart TD
    ...
    details["<a class='internal-link' href='#Details'>Details</a>"]

    form_match["<a class='internal-link' href='#Form Match'>Form Match</a>"]
    details --> form_match

    shapechange["<a class='internal-link' href='#Shapechange'>Shapechange</a>"]

    will_o_wisp["<a class='internal-link' href='#Will-o-Wisp'>Will-o-Wisp</a>"]

    ghostly_presence["<a class='internal-link' href='#Ghostly Presence'>Ghostly Presence</a>"]
    will_o_wisp --> ghostly_presence

    paralyze["<a class='internal-link' href='#Paralyze'>Paralyze</a>"]

    affinity_element_control["<a class='internal-link' href='#Affinity Element Control'>Affinity Element<br>Control</a>"]

    element_control["<a class='internal-link' href='#Element Control'>Element Control</a>"]
    affinity_element_control --> element_control

    weather_control["<a class='internal-link' href='#Weather Control'>Weather Control</a>"]

    ignite["<a class='internal-link' href='#Ignite'>Ignite</a>"]

    element_touch["<a class='internal-link' href='#Element Touch'>Element Touch</a>"]

    element_kiss["<a class='internal-link' href='#Element Kiss'>Element Kiss</a>"]
    element_touch --> element_kiss

    element_infusion["<a class='internal-link' href='#Element Infusion'>Element Infusion</a>"]
...
flowchart TD
    ...
    subgraph Games of Divinity
        uncanny_prowess["<a class='internal-link' href='#Uncanny Prowess'>Uncanny Prowess</a>"]

        creation_of_perfection["<a class='internal-link' href='#Creation of Perfection'>Creation of Perfection</a>"]

        spirit_cutting["<a class='internal-link' href='#Spirit-Cutting'>Spirit-Cutting</a>"]
    end
