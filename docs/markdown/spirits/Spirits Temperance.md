...
flowchart TD
    ...
    cunning_thief["<a class='internal-link' href='#Cunning Thief'>Cunning Thief</a>"]

    host_of_spirits["<a class='internal-link' href='#Host of Spirits'>Host of Spirits</a>"]
...
flowchart TD
    ...
    hoodwink["<a class='internal-link' href='#Hoodwink'>Hoodwink</a>"]

    stillness["<a class='internal-link' href='#Stillness'>Stillness</a>"]

    camouflage["<a class='internal-link' href='#Camouflage'>Camouflage</a>"]
    stillness --> camouflage

    hurry_home["<a class='internal-link' href='#Hurry Home'>Hurry Home</a>"]

    portal["<a class='internal-link' href='#Portal'>Portal</a>"]
    hurry_home --> portal

    transport["<a class='internal-link' href='#Transport'>Transport</a>"]
    portal --> transport

    banish["<a class='internal-link' href='#Banish'>Banish</a>"]
    transport --> banish

    capture["<a class='internal-link' href='#Capture'>Capture</a>"]
    banish --> capture

    sustenance["<a class='internal-link' href='#Sustenance'>Sustenance</a>"]

    steal_sustenance["<a class='internal-link' href='#Steal Sustenance'>Steal Sustenance</a>"]
    sustenance --> steal_sustenance

    subgraph Games of Divinity
        donning_spiritual_armor["<a class='internal-link' href='#Donning Spiritual Armor'>Donning Spiritual Armor</a>"]

        essence_inveigle["<a class='internal-link' href='#Essence Inveigle'>Essence Inveigle</a>"]
    end

    sustenance --> essence_inveigle

    subgraph Kingdom of Halta
        den_of_shadows["<a class='internal-link' href='#Den of Shadows'>Den of Shadows</a>"]
    end
