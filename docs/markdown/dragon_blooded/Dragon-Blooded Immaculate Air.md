...
flowchart TD
    ...
    air_dragon_sight["<a class='internal-link' href='#Air Dragon Sight'>Air Dragon Sight</a>"]

    wind_dragon_speed["<a class='internal-link' href='#Wind Dragon Speed'>Wind Dragon Speed</a>"]
    air_dragon_sight --> wind_dragon_speed

    breath_seizing_technique["<a class='internal-link' href='#Breath-Seizing Technique'>Breath-Seizing Technique</a>"]
    air_dragon_sight --> breath_seizing_technique

    shrouding_the_body_and_mind["<a class='internal-link' href='#Shrouding the Body and Mind'>Shrouding the<br>Body and Mind</a>"]
    air_dragon_sight --> shrouding_the_body_and_mind

    air_dragon_form["<a class='internal-link' href='#Air Dragon Form'>Air Dragon Form</a>"]
    wind_dragon_speed --> air_dragon_form
    breath_seizing_technique --> air_dragon_form
    shrouding_the_body_and_mind --> air_dragon_form

    tornado_offense_technique["<a class='internal-link' href='#Tornado Offense Technique'>Tornado Offense Technique</a>"]
    air_dragon_form --> tornado_offense_technique

    avenging_wind_strike["<a class='internal-link' href='#Avenging Wind Strike'>Avenging Wind Strike</a>"]
    tornado_offense_technique --> avenging_wind_strike

    wrathful_winds_maneuver["<a class='internal-link' href='#Wrathful Winds Maneuver'>Wrathful Winds Maneuver</a>"]
    avenging_wind_strike --> wrathful_winds_maneuver

    cloud_treading_method["<a class='internal-link' href='#Cloud Treading Method'>Cloud Treading Method</a>"]
    air_dragon_form --> cloud_treading_method

    thunderclap_kata["<a class='internal-link' href='#Thunderclap Kata'>Thunderclap Kata</a>"]
    cloud_treading_method --> thunderclap_kata

    lightning_strike_style["<a class='internal-link' href='#Lightning Strike Style'>Lightning Strike Style</a>"]
    thunderclap_kata --> lightning_strike_style

    hurricane_combat_method["<a class='internal-link' href='#Hurricane Combat Method'>Hurricane Combat Method</a>"]
