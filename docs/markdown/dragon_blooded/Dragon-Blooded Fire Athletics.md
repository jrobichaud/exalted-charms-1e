...
flowchart TD
    ...
    subgraph earth_athletics[Earth Athletics Charms]
        ...
        perfect_climbing_attitude["<a class='internal-link' href='#Perfect Climbing Attitude'>Perfect Climbing Attitude</a>"]
...
flowchart TD
    ...
    effortlessly_rising_flame["<a class='internal-link' href='#Effortlessly Rising Flame'>Effortlessly Rising Flame</a>"]

    falling_star_maneuver["<a class='internal-link' href='#Falling Star Maneuver'>Falling Star Maneuver</a>"]
    effortlessly_rising_flame --> falling_star_maneuver

    bellows_pumping_stride["<a class='internal-link' href='#Bellows-Pumping Stride'>Bellows-Pumping Stride</a>"]
    falling_star_maneuver --> bellows_pumping_stride

    incense_smoke_ladder["<a class='internal-link' href='#Incense Smoke Ladder'>Incense Smoke Ladder</a>"]
    ...
    swift_legion_technique["<a class='internal-link' href='#Swift Legion Technique'>Swift Legion Technique</a>"]
    bellows_pumping_stride --> swift_legion_technique
    fiery_prowess --> swift_legion_technique


subgraph Aspect Book - Fire
    flawless_balance_discipline["<a class='internal-link' href='#Flawless Balance Discipline'>Flawless Balance<br>Discipline</a>"]
end


effortlessly_rising_flame --> flawless_balance_discipline
