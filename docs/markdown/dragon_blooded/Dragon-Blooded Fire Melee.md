...
flowchart TD
    ...
    subgraph air_melee[Air Melee Charms]
        ...
        one_mind_technique["<a class='internal-link' href='#One Mind Technique'>One Mind Technique</a>"]
...
flowchart TD
    ...
    dragon_graced_weapon["<a class='internal-link' href='#Dragon-Graced Weapon'>Dragon-Graced Weapon</a>"]

    ghost_fire_blade["<a class='internal-link' href='#Ghost-Fire Blade'>Ghost-Fire Blade</a>"]
    dragon_graced_weapon --> ghost_fire_blade

    refining_the_inner_blade["<a class='internal-link' href='#Refining the Inner Blade'>Refining the Inner Blade</a>"]
    dragon_graced_weapon --> refining_the_inner_blade

    stoking_bonfire_style["<a class='internal-link' href='#Stoking Bonfire Style'>Stoking Bonfire Style</a>"]

    portentous_comet_deflecting_mode["<a class='internal-link' href='#Portentous Comet-Deflecting Mode'>Portentous<br>Comet-Deflecting<br>Mode</a>"]
    stoking_bonfire_style --> portentous_comet_deflecting_mode

    deadly_wildfire_legion["<a class='internal-link' href='#Deadly Wildfire Legion'>Deadly Wildfire Legion</a>"]
    stoking_bonfire_style ---> deadly_wildfire_legion

    threshold_floor_technique["<a class='internal-link' href='#Threshold Floor Technique'>Threshold Floor Technique</a>"]
    stoking_bonfire_style ----> threshold_floor_technique

    ringing_anvil_onslaught["<a class='internal-link' href='#Ringing Anvil Onslaught'>Ringing Anvil Onslaught</a>"]
    threshold_floor_technique --> ringing_anvil_onslaught

subgraph Aspect Book - Fire
    fire_incites_water_to_a_riot_of_clouds["<a class='internal-link' href='#Fire Incites Water to a Riot of Clouds'>Fire Incites Water to a<br>Riot of Clouds</a>"]



    style_countering_meditation["<a class='internal-link' href='#Style-Countering Meditation'>Style-Countering<br>Meditation</a>"]

    blinding_spark_distraction["<a class='internal-link' href='#Blinding Spark Distraction'>Blinding Spark<br>Distraction</a>"]

    spirit_branding_blade_technique["<a class='internal-link' href='#Spirit-Branding Blade Technique'>Spirit-Branding<br>Blade Technique</a>"]
end

dragon_graced_weapon --> fire_incites_water_to_a_riot_of_clouds
dragon_graced_weapon --> blinding_spark_distraction
ghost_fire_blade --> spirit_branding_blade_technique
