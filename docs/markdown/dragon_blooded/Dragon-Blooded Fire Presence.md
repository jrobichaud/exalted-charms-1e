...
flowchart TD
    ...
    fire_in_the_belly_attitude["<a class='internal-link' href='#Fire in the Belly Attitude'>Fire in the Belly Attitude</a>"]

    phantom_fire_warrior_horde["<a class='internal-link' href='#Phantom Fire-Warrior Horde'>Phantom Fire-Warrior<br>Horde</a>"]

    blazing_courageous_swordsmen_inspiration["<a class='internal-link' href='#Blazing Courageous Swordsmen Inspiration'>Blazing Courageous<br>Swordsmen Inspiration</a>"]
    phantom_fire_warrior_horde --> blazing_courageous_swordsmen_inspiration

    glowing_coal_radiance["<a class='internal-link' href='#Glowing Coal Radiance'>Glowing Coal Radiance</a>"]
    ...
    unbearable_taunt_technique["<a class='internal-link' href='#Unbearable Taunt Technique'>Unbearable Taunt<br>Technique</a>"]
    glowing_coal_radiance --> unbearable_taunt_technique

    moth_to_the_candle["<a class='internal-link' href='#Moth to the Candle'>Moth to the Candle</a>"]
    unbearable_taunt_technique --> moth_to_the_candle

subgraph Aspect Book - Fire
    auspicious_first_meeting_attitude["<a class='internal-link' href='#Auspicious First Meeting Attitude'>Auspicious First<br>Meeting Attitude</a>"]

    passion_transmuting_nuance["<a class='internal-link' href='#Passion Transmuting Nuance'>Passion Transmuting<br>Nuance</a>"]

    incendiary_fire_dragon_shout["<a class='internal-link' href='#Incendiary Fire Dragon Shout'>Incendiary Fire<br>Dragon Shout</a>"]
end

aura_of_invulnerability ---> incendiary_fire_dragon_shout
