...
flowchart TD
    ...
    subgraph fire_survival[Fire Survival Charms]
        ...
        precise_fire_method["<a class='internal-link' href='#Precise Fire Method'>Precise Fire Method</a>"]
...
flowchart TD
    ...
    forest_passage_method["<a class='internal-link' href='#Forest Passage Method'>Forest Passage Method</a>"]

    wild_wandering_forester_charm["<a class='internal-link' href='#Wild-Wandering Forester Charm'>Wild-Wandering<br>Forester Charm</a>"]

    forgiveness_of_nature_invoking_prana["<a class='internal-link' href='#Forgiveness of Nature Invoking Prana'>Forgiveness of<br>Nature Invoking Prana</a>"]
    wild_wandering_forester_charm ---> forgiveness_of_nature_invoking_prana

    quarry_revelation_technique["<a class='internal-link' href='#Quarry Revelation Technique'>Quarry Revelation<br>Technique</a>"]
    wild_wandering_forester_charm ----> quarry_revelation_technique

    trail_concealing_measurement["<a class='internal-link' href='#Trail Concealing Measurement'>Trail Concealing<br>Measurement</a>"]
    quarry_revelation_technique --> trail_concealing_measurement

    ration_enhancing_method["<a class='internal-link' href='#Ration-Enhancing Method'>Ration-Enhancing Method</a>"]
    quarry_revelation_technique --> ration_enhancing_method

    hostile_environment_preparation["<a class='internal-link' href='#Hostile Environment Preparation'>Hostile Environment<br>Preparation</a>"]
    wild_wandering_forester_charm ------> hostile_environment_preparation

    shelter_creation_technique["<a class='internal-link' href='#Shelter Creation Technique'>Shelter Creation Technique</a>"]
