...
flowchart TD
    ...
    force_of_the_mountain["<a class='internal-link' href='#Force of the Mountain'>Force of the Mountain</a>"]
    ...
    shattering_fist_strike["<a class='internal-link' href='#Shattering Fist Strike'>Shattering Fist Strike</a>"]
    earth_dragon_form --> shattering_fist_strike

    weapon_breaking_defense_technique["<a class='internal-link' href='#Weapon-Breaking Defense Technique'>Weapon-Breaking<br>Defense Technique</a>"]
    shattering_fist_strike --> weapon_breaking_defense_technique

    stillness_of_stone["<a class='internal-link' href='#Stillness of Stone'>Stillness of Stone</a>"]
    earth_dragon_form --> stillness_of_stone

    avalanche_method["<a class='internal-link' href='#Avalanche Method'>Avalanche Method</a>"]
    stillness_of_stone --> avalanche_method

    earthshaker_attack["<a class='internal-link' href='#Earthshaker Attack'>Earthshaker Attack</a>"]
    earth_dragon_form --> earthshaker_attack

    hungry_earth_strike["<a class='internal-link' href='#Hungry Earth Strike'>Hungry Earth Strike</a>"]
    earthshaker_attack --> hungry_earth_strike

    ghost_grounding_blow["<a class='internal-link' href='#Ghost-Grounding Blow'>Ghost-Grounding Blow</a>"]
    ...
    perfection_of_earth_body["<a class='internal-link' href='#Perfection of Earth Body'>Perfection of Earth Body</a>"]
