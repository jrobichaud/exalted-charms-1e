...
flowchart TD
    ...
    strength_of_stone_technique["<a class='internal-link' href='#Strength of Stone Technique'>Strength of Stone<br>Technique</a>"]

    impervious_skin_of_stone_meditation["<a class='internal-link' href='#Impervious Skin of Stone Meditation'>Impervious Skin of<br>Stone Meditation</a>"]
    strength_of_stone_technique --> impervious_skin_of_stone_meditation

    mountain_toppling_method["<a class='internal-link' href='#Mountain Toppling Method'>Mountain Toppling Method</a>"]
    strength_of_stone_technique --> mountain_toppling_method

    element_protection_form["<a class='internal-link' href='#(Element) Protection Form'>(Element) Protection Form</a>"]
    impervious_skin_of_stone_meditation --> element_protection_form

    chaos_warding_prana["<a class='internal-link' href='#Chaos-Warding Prana'>Chaos-Warding Prana</a>"]
    element_protection_form --> chaos_warding_prana

    defense_from_anathema_method["<a class='internal-link' href='#Defense from Anathema Method'>Defense from Anathema<br>Method</a>"]
    chaos_warding_prana --> defense_from_anathema_method

    subgraph Aspect Book - Earth
        armor_hardening_concentration["<a class='internal-link' href='#Armor-Hardening Concentration'>Armor-Hardening<br>Concentration</a>"]

        mantle_of_element_invulnerability["<a class='internal-link' href='#Mantle of (Element) Invulnerability'>Mantle of (Element)<br>Invulnerability</a>"]
        perfected_scales_of_the_dragon["<a class='internal-link' href='#Perfected Scales of the Dragon'>Perfected Scales of<br>the Dragon</a>"]

        taint_cleansing_technique["<a class='internal-link' href='#Taint-Cleansing Technique'>Taint-Cleansing<br>Technique</a>"]

    end

    strength_of_stone_technique --> armor_hardening_concentration
    element_protection_form --> |Appropriate Element| mantle_of_element_invulnerability
    mantle_of_element_invulnerability --> |All five| perfected_scales_of_the_dragon
    chaos_warding_prana --> taint_cleansing_technique
