...
flowchart TD
    ...
    drowning_embrace["<a class='internal-link' href='#Drowning Embrace'>Drowning Embrace</a>"]

    riptide_method["<a class='internal-link' href='#Riptide Method'>Riptide Method</a>"]
    drowning_embrace --> riptide_method

    pounding_surf_style["<a class='internal-link' href='#Pounding Surf Style'>Pounding Surf Style</a>"]
    drowning_embrace --> pounding_surf_style

    fist_spinning_maelstrom["<a class='internal-link' href='#Fist-Spinning Maelstrom'>Fist-Spinning Maelstrom</a>"]
    pounding_surf_style --> fist_spinning_maelstrom

    blade_deflecting_palm["<a class='internal-link' href='#Blade-Deflecting Palm'>Blade-Deflecting Palm</a>"]

    become_the_hammer["<a class='internal-link' href='#Become the Hammer'>Become the Hammer</a>"]
    blade_deflecting_palm --> become_the_hammer

    flow_past_defences["<a class='internal-link' href='#Flow Past Defenses'>Flow Past Defenses</a>"]
    ...
    subgraph Aspect Book - Water
        bonds_of_unbreakable_ice_technique["<a class='internal-link' href='#Bonds of Unbreakable Ice Technique'>Bonds of Unbreakable<br>Ice Technique</a>"]

        crushing_glacier_prana["<a class='internal-link' href='#Crushing Glacier Prana'>Crushing Glacier Prana</a>"]

        smashing_tidal_wave_technique["<a class='internal-link' href='#Smashing Tidal Wave Technique'>Smashing Tidal Wave<br>Technique</a>"]

        slippery_escape_method["<a class='internal-link' href='#Slippery Escape Method'>Slippery Escape Method</a>"]
        swift_stream_prana["<a class='internal-link' href='#Swift Stream Prana'>Swift Stream Prana</a>"]
        disarming_strike_prana["<a class='internal-link' href='#Disarming Strike Prana'>Disarming Strike Prana</a>"]

    end

    riptide_method ---> bonds_of_unbreakable_ice_technique
    bonds_of_unbreakable_ice_technique --> crushing_glacier_prana
    crushing_glacier_prana --> smashing_tidal_wave_technique
    drowning_embrace --> slippery_escape_method
    slippery_escape_method --> swift_stream_prana
    become_the_hammer --> disarming_strike_prana
