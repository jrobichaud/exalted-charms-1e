...
flowchart TD
    ...
    scattered_pearl_hoof_falls["<a class='internal-link' href='#Scattered Pearl Hoof Falls'>Scattered Pearl Hoof Falls</a>"]

    heaven_gracing_leap["<a class='internal-link' href='#Heaven-Gracing Leap'>Heaven-Gracing Leap</a>"]
    scattered_pearl_hoof_falls --> heaven_gracing_leap

    cloud_harnessing_method["<a class='internal-link' href='#Cloud-Harnessing Method'>Cloud-Harnessing Method</a>"]
    heaven_gracing_leap --> cloud_harnessing_method

    ebony_spur_technique["<a class='internal-link' href='#Ebony Spur Technique'>Ebony Spur Technique</a>"]
    scattered_pearl_hoof_falls --> ebony_spur_technique

    charge_of_one_hundred_generals["<a class='internal-link' href='#Charge of One Hundred Generals'>Charge of<br>One Hundred Generals</a>"]
    ebony_spur_technique --> charge_of_one_hundred_generals

    great_heart_companion["<a class='internal-link' href='#Great Heart Companion'>Great Heart Companion</a>"]
    scattered_pearl_hoof_falls ----> great_heart_companion

    dance_of_the_jade_bridle["<a class='internal-link' href='#Dance of the Jade Bridle'>Dance of the Jade Bridle</a>"]
