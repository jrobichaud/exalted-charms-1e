...
flowchart TD
    ...
    subgraph air_awareness[Air Awareness Charms]
        ...
        voice_on_the_wind_technique["<a class='internal-link' href='#Voice on the Wind Technique'>Voice on the<br>Wind Technique</a>"]
...
flowchart TD
    ...
    precision_observation_method["<a class='internal-link' href='#Precision Observation Method'>Precision Observation<br>Method</a>"]
    ...
    sense_riding_technique["<a class='internal-link' href='#Sense Riding Technique'>(Sense) Riding Technique</a>"]
    precision_observation_method ------> sense_riding_technique

    sense_destroying_method["<a class='internal-link' href='#Sense Destroying Method'>(Sense) Destroying Method</a>"]
    sense_riding_technique --> sense_destroying_method

    essence_disruption_attack["<a class='internal-link' href='#Essence Disruption Attack'>Essence Disruption Attack</a>"]
    ...
    feeling_the_dragons_bones --> pulse_of_the_dragons_soul
