...
flowchart TD
    ...
    subgraph water_occult[Water Occult Charms]
        ...
        spirit_reflecting_bowl["<a class='internal-link' href='#Spirit-Reflecting Bowl Technique'>Spirit-Reflecting Bowl<br>Technique</a>"]
...
flowchart TD
    ...
    stormwind_calling_method["<a class='internal-link' href='#Stormwind Calling Method'>Stormwind Calling Method</a>"]

    spirit_detecting_mirror_technique["<a class='internal-link' href='#Spirit-Detecting Mirror Technique'>Spirit-Detecting<br>Mirror Technique</a>"]

    harmonious_wind_luring_song["<a class='internal-link' href='#Harmonious Wind-Luring Song'>Harmonious Wind-Luring<br>Song</a>"]
    spirit_detecting_mirror_technique --> harmonious_wind_luring_song

    spirit_grounding_shout["<a class='internal-link' href='#Spirit-Grounding Shout'>Spirit-Grounding Shout</a>"]
    spirit_detecting_mirror_technique ---> spirit_grounding_shout

    spirit_chaining_strike["<a class='internal-link' href='#Spirit-Chaining Strike'>Spirit-Chaining Strike</a>"]
    spirit_grounding_shout --> spirit_chaining_strike

    spirit_shredding_attack["<a class='internal-link' href='#Spirit-Shredding Attack'>Spirit-Shredding Attack</a>"]
