...
flowchart TD
    ...
    geese_flying_south_administration["<a class='internal-link' href='#Geese-Flying South Administration'>Geese-Flying South<br>Administration</a>"]
    confluence_of_savant_thought --> geese_flying_south_administration

    bestow_the_saffron_mantle["<a class='internal-link' href='#Bestow the Saffron Mantle'>Bestow the Saffron Mantle</a>"]
    geese_flying_south_administration --> bestow_the_saffron_mantle

    thrashing_carp_serenade["<a class='internal-link' href='#Thrashing Carp Serenade'>Thrashing Carp Serenade</a>"]
    benevolent_masters_blessing --> thrashing_carp_serenade

    thoughtful_gift_technique["<a class='internal-link' href='#Thoughtful Gift Technique'>Thoughtful Gift Technique</a>"]
    thrashing_carp_serenade --> thoughtful_gift_technique

    testing_the_waters["<a class='internal-link' href='#Testing the Waters'>Testing the Waters</a>"]
    ...
    subgraph Aspect Book - Water
        ...
        distraction_of_the_babbling_brook["<a class='internal-link' href='#Distraction of the Babbling Brook'>Distraction of the<br>Babbling Brook</a>"]
        dashing_brook_method["<a class='internal-link' href='#Dashing Brook Method'>Dashing Brook Method</a>"]

    end

    finding_the_waters_depths --> sparkling_fountains_of_eloquence
    sparkling_fountains_of_eloquence --> distraction_of_the_babbling_brook
    geese_flying_south_administration -----> dashing_brook_method
