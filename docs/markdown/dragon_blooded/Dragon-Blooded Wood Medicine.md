...
flowchart TD
    ...
    subgraph water_medicine[Water Medicine Charms]
        ...
        drowning_in_blood_strike["<a class='internal-link' href='#Drowning-in-blood-strike'>Drowning-in-blood-strike</a>"]
...
flowchart TD
    ...
    herbal_medicine_techniques["<a class='internal-link' href='#Herbal Medicine Techniques'>Herbal Medicine Techniques</a>"]

    infection_banishing_prana["<a class='internal-link' href='#Infection-Banishing Prana'>Infection-Banishing Prana</a>"]

    dread_infection_strike["<a class='internal-link' href='#Dread Infection Strike'>Dread Infection Strike</a>"]
    infection_banishing_prana --> dread_infection_strike

    disease_banishing_technique["<a class='internal-link' href='#Disease-Banishing Technique'>Disease-Banishing<br>Technique</a>"]
    infection_banishing_prana --> disease_banishing_technique

    wound_closing_touch["<a class='internal-link' href='#Wound-Closing Touch'>Wound-Closing Touch</a>"]
    disease_banishing_technique --> wound_closing_touch

    grievous_wound_alteration_energy["<a class='internal-link' href='#Grievous Wound Alteration Energy'>Grievous Wound<br>Alteration Energy</a>"]
    wound_closing_touch --> grievous_wound_alteration_energy

    madness_analysis_stare["<a class='internal-link' href='#Madness Analysis Stare'>Madness Analysis Stare</a>"]
    infection_banishing_prana --> madness_analysis_stare

    purity_of_mind_method["<a class='internal-link' href='#Purity of Mind Method'>Purity of Mind Method</a>"]
    wound_closing_touch --> purity_of_mind_method
    madness_analysis_stare --> purity_of_mind_method

    subgraph Aspect Book - Fire
        spark_kindling_rescue_technique["<a class='internal-link' href='#Spark Kindling Rescue Technique'>Spark Kindling<br>Rescue Technique</a>"]
    end

    subgraph Aspect Book - Wood
        verdant_curtains_of_serenity["<a class='internal-link' href='#Verdant Curtains of Serenity'>Verdant Curtains<br>of Serenity</a>"]
        jade_crucible_method["<a class='internal-link' href='#Jade Crucible Method'>Jade Crucible Method</a>"]
        most_beneficent_seed_of_the_five_dragons["<a class='internal-link' href='#Most Beneficent Seed of the Five Dragons'>Most Beneficent Seed<br>of the Five Dragons</a>"]

    end
    purity_of_mind_method --> verdant_curtains_of_serenity
    dread_infection_strike --> jade_crucible_method
    grievous_wound_alteration_energy --> jade_crucible_method
    purity_of_mind_method --> jade_crucible_method
    jade_crucible_method --> most_beneficent_seed_of_the_five_dragons
...
used Madness Analysis Stare to learn the source of the
...
Emerald Countermagic. Like Madness Analysis Stare,
