...
flowchart TD
    ...
    subgraph wood_dodge[Wood Dodge Charms]
        ...
        snarling_undergrowth_form["<a class='internal-link' href='#Snarling Undergrowth Form'>Snarling Undergrowth Form</a>"]
...
flowchart TD
    ...
    leaping_flame_attitude["<a class='internal-link' href='#Leaping Flame Attitude'>Leaping Flame Attitude</a>"]

    threshold_warding_stance["<a class='internal-link' href='#Threshold-Warding Stance'>Threshold-Warding Stance</a>"]

    hopping_firecracker_evasion["<a class='internal-link' href='#Hopping Firecracker Evasion'>Hopping Firecracker<br>Evasion</a>"]
    threshold_warding_stance --> hopping_firecracker_evasion

    virtuous_negation_defense["<a class='internal-link' href='#Virtuous Negation Defense'>Virtuous Negation Defense</a>"]
    hopping_firecracker_evasion --> virtuous_negation_defense

    flickering_candle_meditation["<a class='internal-link' href='#Flickering Candle Meditation'>Flickering Candle<br>Meditation</a>"]

    smoke_obscuring_effect["<a class='internal-link' href='#Smoke Obscuring Effect'>Smoke Obscuring Effect</a>"]
    flickering_candle_meditation --> smoke_obscuring_effect

    safety_among_enemies["<a class='internal-link' href='#Safety Among Enemies'>Safety Among Enemies</a>"]
    flickering_candle_meditation --> safety_among_enemies

    arrow_consuming_flame_defense["<a class='internal-link' href='#Arrow-Consuming Flame Defense'>Arrow-Consuming<br>Flame Defense</a>"]
    safety_among_enemies --> arrow_consuming_flame_defense

    smoldering_karma_strike["<a class='internal-link' href='#Smoldering Karma Strike'>Smoldering Karma Strike</a>"]
...
subgraph Aspect Book - Fire
    unassailable_body_of_flame_defense["<a class='internal-link' href='#Unassailable Body of Flame Defense'>Unassailable Body of<br>Flame Defense</a>"]
end

smoldering_karma_strike --> unassailable_body_of_flame_defense
