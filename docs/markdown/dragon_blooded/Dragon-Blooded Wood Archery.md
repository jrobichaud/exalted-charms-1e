...
flowchart TD
    ...
    spring_follows_winter["<a class='internal-link' href='#Spring Follows Winter'>Spring Follows Winter</a>"]

    swallows_defend_the_nest["<a class='internal-link' href='#Swallows Defend the Nest'>Swallows Defend the Nest</a>"]
    spring_follows_winter --> swallows_defend_the_nest

    harvest_of_the_hunter["<a class='internal-link' href='#Harvest of the Hunter'>Harvest of the Hunter</a>"]
    spring_follows_winter --> harvest_of_the_hunter

    life_swelling_sap_strike["<a class='internal-link' href='#Life-Swelling Sap Strike'>Life-Swelling Sap Strike</a>"]
    harvest_of_the_hunter --> life_swelling_sap_strike

    dragonfly_finds_mate["<a class='internal-link' href='#Dragonfly Finds Mate'>Dragonfly Finds Mate</a>"]
    spring_follows_winter --> dragonfly_finds_mate

    seven_year_swarm_volley["<a class='internal-link' href='#Seven-Year Swarm Volley'>Seven-Year Swarm Volley</a>"]
    dragonfly_finds_mate --> seven_year_swarm_volley

    sparrow_dives_at_hawk["<a class='internal-link' href='#Sparrow Dives at Hawk'>Sparrow Dives at Hawk</a>"]
    ...
    harvest_of_the_hunter --> unobstructed_hunters_aim
    life_swelling_sap_strike --> ravenous_thorn_technique
