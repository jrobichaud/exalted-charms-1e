...
flowchart TD
    ...
    subgraph fire_investigation[Fire Investigation Charms]
        ...
        revealing_light_method["<a class='internal-link' href='#Revealing Light Method'>Revealing Light Method</a>"]
    end
...
flowchart TD
    ...
    indisputable_physical_analysis_technique["<a class='internal-link' href='#Indisputable Physical Analysis Technique'>Indisputable Physical<br>Analysis Technique</a>"]

    scent_of_crime_method["<a class='internal-link' href='#Scent of Crime Method'>Scent of Crime Method</a>"]
    ...
    revelation_of_associates_hunch["<a class='internal-link' href='#Revelation of Associates Hunch'>Revelation of<br>Associates Hunch</a>"]
    indisputable_physical_analysis_technique --> revelation_of_associates_hunch

    homeward_trail_discovery_method["<a class='internal-link' href='#Homeward Trail Discovery Method'>Homeward Trail<br>Discovery Method</a>"]
    ...
    subgraph Aspect Book - Water
        tampering_detection_technique["<a class='internal-link' href='#Tampering Detection Technique'>Tampering Detection<br>Technique</a>"]
        clear_water_prana["<a class='internal-link' href='#Clear Water Prana'>Clear Water Prana</a>"]
        eye_of_the_enlightened_reader["<a class='internal-link' href='#Eye of the Enlightened Reader'>Eye of the<br>Enlightened Reader</a>"]
        information_carrying_tide["<a class='internal-link' href='#Information Carrying Tide'>Information Carrying<br>Tide</a>"]
    end

    indisputable_physical_analysis_technique --> tampering_detection_technique
    tampering_detection_technique --> clear_water_prana
    indisputable_physical_analysis_technique --> eye_of_the_enlightened_reader
    eye_of_the_enlightened_reader --> information_carrying_tide
