...
flowchart TD
    ...
    monkey_tail_distraction_strike["<a class='internal-link' href='#Monkey Tail Distraction Strike'>Monkey Tail<br>Distraction Strike</a>"]

    flowing_mirror_of_opposition_technique["<a class='internal-link' href='#Flowing Mirror of Opposition Technique'>Flowing Mirror of<br>Opposition Technique</a>"]
    monkey_tail_distraction_strike --> flowing_mirror_of_opposition_technique

    body_of_war_meditation["<a class='internal-link' href='#Body of War Meditation'>Body of War Meditation</a>"]

    withering_paw_strike["<a class='internal-link' href='#Withering Paw Strike'>Withering Paw Strike</a>"]
    body_of_war_meditation --> withering_paw_strike

    celestial_monkey_form["<a class='internal-link' href='#Celestial Monkey Form'>Celestial Monkey Form</a>"]
    flowing_mirror_of_opposition_technique --> celestial_monkey_form
    withering_paw_strike --> celestial_monkey_form

    walking_in_footsteps_of_ten_thousand_things["<a class='internal-link' href='#Walking in the Footsteps of Ten Thousand Things'>Walking in the<br>Footsteps of Ten<br>Thousand Things</a>"]
    celestial_monkey_form --> walking_in_footsteps_of_ten_thousand_things

    four_halo_golden_monkey_palm["<a class='internal-link' href='#Four Halo Golden Monkey Palm'>Four Halo Golden<br>Monkey Palm</a>"]
    walking_in_footsteps_of_ten_thousand_things --> four_halo_golden_monkey_palm

    four_halo_golden_monkey_realignment["<a class='internal-link' href='#Four Halo Golden Monkey Realignment'>Four Halo Golden<br>Monkey Realignment</a>"]
    four_halo_golden_monkey_palm --> four_halo_golden_monkey_realignment

    celestial_godbody_understanding["<a class='internal-link' href='#Celestial Godbody Understanding'>Celestial Godbody<br>Understanding</a>"]
    four_halo_golden_monkey_realignment --> celestial_godbody_understanding
