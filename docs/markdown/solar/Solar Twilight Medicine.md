...
flowchart TD
    ...
    body_mending_meditation["<a class='internal-link' href='#Body-Mending Meditation'>Body-Mending Meditation</a>"]

    flawless_diagnosis_technique["<a class='internal-link' href='#Flawless Diagnosis Technique'>Flawless Diagnosis<br>Technique</a>"]
    body_mending_meditation --> flawless_diagnosis_technique

    ailment_rectifying_method["<a class='internal-link' href='#Ailment-Rectifying Method'>Ailment-Rectifying Method</a>"]
    flawless_diagnosis_technique --> ailment_rectifying_method

    contagion_curing_touch["<a class='internal-link' href='#Contagion-Curing Touch'>Contagion-Curing Touch</a>"]
    ailment_rectifying_method --> contagion_curing_touch

    touch_of_blissful_release["<a class='internal-link' href='#Touch of Blissful Release'>Touch of Blissful Release</a>"]
    body_mending_meditation --> touch_of_blissful_release

    grievous_injury_recovery_method["<a class='internal-link' href='#Grievous Injury Recovery Method'>Grievous Injury<br>Recovery Method</a>"]
    body_mending_meditation --> grievous_injury_recovery_method

    wound_mending_care_technique["<a class='internal-link' href='#Wound-Mending Care Technique'>Wound-Mending<br>Care Technique</a>"]
    touch_of_blissful_release --> wound_mending_care_technique
    grievous_injury_recovery_method --> wound_mending_care_technique

    anointment_of_miraculous_health["<a class='internal-link' href='#Anointment of Miraculous Health'>Anointment of Miraculous<br>Health</a>"]
    contagion_curing_touch --> anointment_of_miraculous_health
    wound_mending_care_technique --> anointment_of_miraculous_health

    bodily_regeneration_prana["<a class='internal-link' href='#Bodily Regeneration Prana'>Bodily Regeneration<br>Prana</a>"]
    wound_mending_care_technique --> bodily_regeneration_prana

    healing_trance_meditation["<a class='internal-link' href='#Healing Trance Meditation'>Healing Trance<br>Meditation</a>"]
    ...
    subgraph Castebook Twilight
        direction TB
        addiction_cleansing_touch["<a class='internal-link' href='#Addiction-Cleansing Touch'>Addiction-Cleansing Touch</a>"]

        unhealing_wound_infliction["<a class='internal-link' href='#Unhealing Wound Infliction'>Unhealing Wound<br>Infliction</a>"]

        merciful_balm_of_sleep["<a class='internal-link' href='#Merciful Balm of Sleep'>Merciful Balm of Sleep</a>"]

        youth_restoring_benison["<a class='internal-link' href='#Youth-Restoring Benison'>Youth-Restoring<br>Benison</a>"]
    end
    ...
    subgraph Castebook Night
        venom_anodyne_method["<a class='internal-link' href='#Venom Anodyne Method'>Venom Anodyne Method</a>"]

        body_purifying_technique["<a class='internal-link' href='#Body Purifying Technique'>Body Purifying Technique</a>"]
    end
