...
flowchart TD
    ...
    solar_circle_sorcery["<a class='internal-link' href='#Solar Circle Sorcery'>Solar Circle Sorcery</a>"]
    celestial_circle_sorcery --> solar_circle_sorcery

    spirit_detecting_glance["<a class='internal-link' href='#Spirit Detecting Glance'>Spirit Detecting Glance</a>"]

    spirit_cutting_attack["<a class='internal-link' href='#Spirit-Cutting Attack'>Spirit-Cutting Attack</a>"]
    spirit_detecting_glance --> spirit_cutting_attack

    ghost_eating_technique["<a class='internal-link' href='#Ghost-Eating Technique'>Ghost-Eating Technique</a>"]
    ...
    subgraph Castebook Twilight
        direction TB
        power_draining_whisper["<a class='internal-link' href='#Power-Draining Whisper'>Power-Draining Whisper</a>"]

        power_disrupting_blow["<a class='internal-link' href='#Power-Disrupting Blow'>Power-Disrupting Blow</a>"]

        spirit_warding_band["<a class='internal-link' href='#Spirit-Warding Band'>Spirit-Warding Band</a>"]
    end
