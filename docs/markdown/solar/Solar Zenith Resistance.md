...
flowchart TD
    ...
    durability_of_oak_meditation["<a class='internal-link' href='#Durability of Oak Meditation'>Durability of Oak<br>Meditation</a>"]

    iron_skin_concentration["<a class='internal-link' href='#Iron Skin Concentration'>Iron Skin Concentration</a>"]
    durability_of_oak_meditation --> iron_skin_concentration

    spirit_strengthens_the_skin["<a class='internal-link' href='#Spirit Strengthens the Skin'>Spirit Strengthens the Skin</a>"]
    durability_of_oak_meditation --> spirit_strengthens_the_skin

    adamant_skin_technique["<a class='internal-link' href='#Adamant Skin Technique'>Adamant Skin Technique</a>"]
    spirit_strengthens_the_skin --> adamant_skin_technique
    iron_skin_concentration --> adamant_skin_technique

    unfailing_tortoise_technique["<a class='internal-link' href='#Unfailing Tortoise Technique'>Unfailing Tortoise<br>Technique</a>"]
    durability_of_oak_meditation --> unfailing_tortoise_technique

    iron_kettle_body["<a class='internal-link' href='#Iron Kettle Body'>Iron Kettle Body</a>"]
    ...
    subgraph Castebook Zenith
        direction TB
        environmental_hazard_resisting_meditation["<a class='internal-link' href='#Environmental Hazard-Resisting Meditation'>Environmental Hazard-Resisting<br>Meditation</a>"]

        alcohol_resisting_prana["<a class='internal-link' href='#Alcohol-Resisting Prana'>Alcohol-Resisting<br>Prana</a>"]

        drunken_warrior_technique["<a class='internal-link' href='#Drunken Warrior Technique'>Drunken Warrior<br>Technique</a>"]
        alcohol_resisting_prana --> drunken_warrior_technique

        inebriated_fool_defense["<a class='internal-link' href='#Inebriated Fool Defense'>Inebriated Fool<br>Defense</a>"]
        drunken_warrior_technique --> inebriated_fool_defense

        interrogation_resisting_attitude["<a class='internal-link' href='#Interrogation-Resisting Attitude'>Interrogation-Resisting<br>Attitude</a>"]

        pain_reducing_meditation["<a class='internal-link' href='#Pain-Reducing Meditation'>Pain-Reducing<br>Meditation</a>"]
        interrogation_resisting_attitude --> pain_reducing_meditation

        armor_of_virtue_technique["<a class='internal-link' href='#Armor of Virtue Technique'>Armor of Virtue<br>Technique</a>"]

        fivefold_armon_of_virtue_technique["<a class='internal-link' href='#Fivefold Armor of Virtue Technique'>Fivefold Armor of Virtue<br>Technique</a>"]
...
flowchart TD
    ...
    whirlwind_armor_donning_prana["<a class='internal-link' href='#Whirlwind Armor-Donning Prana'>Whirlwind Armor-Donning<br>Prana</a>"]

    hauberk_summoning_gesture["<a class='internal-link' href='#Hauberk-Summoning Gesture'>Hauberk-Summoning<br>Gesture</a>"]
    whirlwind_armor_donning_prana --> hauberk_summoning_gesture

    glorious_solar_plate["<a class='internal-link' href='#Glorious Solar Plate'>Glorious Solar Plate</a>"]
    hauberk_summoning_gesture --> glorious_solar_plate

    poison_resisting_meditation["<a class='internal-link' href='#Poison-Resisting Meditation'>Poison-Resisting<br>Meditation</a>"]

    illness_resisting_meditation["<a class='internal-link' href='#Illness-Resisting Meditation'>Illness-Resisting<br>Meditation</a>"]

    immunity_to_everything_technique["<a class='internal-link' href='#Immunity to Everything Technique'>Immunity to Everything<br>Technique</a>"]
