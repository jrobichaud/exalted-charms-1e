...
flowchart TD
    ...
    seasoned_criminal_method["<a class='internal-link' href='#Seasoned Criminal Method'>Seasoned Criminal Method</a>"]

    flawlessly_impenetrable_disguise["<a class='internal-link' href='#Flawlessly Impenetrable Disguise'>Flawlessly Impenetrable<br>Disguise</a>"]

    perfect_mirror["<a class='internal-link' href='#Perfect Mirror'>Perfect Mirror</a>"]
    flawlessly_impenetrable_disguise --> perfect_mirror

    flawless_pickpocketing_technique["<a class='internal-link' href='#Flawless Pickpocketing Technique'>Flawless Pickpocketing<br>Technique</a>"]
    ...
    door_evading_technique["<a class='internal-link' href='#Door-Evading Technique'>Door-Evading Technique</a>"]
    lock_opening_touch ---> door_evading_technique

    subgraph Castebook Night
        inescapable_shadow_of_the_sun["<a class='internal-link' href='#Inescapable Shadow of the Sun'>Inescapable Shadow of the Sun</a>"]

        impassable_portal_technique["<a class='internal-link' href='#Impassable Portal Technique'>Impassable Portal Technique</a>"]
    end
