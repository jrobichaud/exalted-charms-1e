...
flowchart TD
    ...
    ferocious_jab["<a class='internal-link' href='#Ferocious Jab'>Ferocious Jab</a>"]

    fist_of_iron_technique["<a class='internal-link' href='#Fist of Iron Technique'>Fist of Iron Technique</a>"]
    ferocious_jab --> fist_of_iron_technique

    ox_stunning_blow["<a class='internal-link' href='#Ox-Stunning Blow'>Ox-Stunning Blow</a>"]
    fist_of_iron_technique --> ox_stunning_blow

    dragon_coil_technique["<a class='internal-link' href='#Dragon Coil Technique'>Dragon Coil Technique</a>"]
    fist_of_iron_technique --> dragon_coil_technique

    thunderclap_rush_attack["<a class='internal-link' href='#Thunderclap Rush Attack'>Thunderclap Rush Attack</a>"]
    ferocious_jab --> thunderclap_rush_attack

    hammer_on_iron_technique["<a class='internal-link' href='#Hammer on Iron Technique'>Hammer on Iron Technique</a>"]
    thunderclap_rush_attack --> hammer_on_iron_technique

    sledgehammer_fist_punch["<a class='internal-link' href='#Sledgehammer Fist Punch'>Sledgehammer Fist Punch</a>"]

    crashing_wave_throw["<a class='internal-link' href='#Crashing Wave Throw'>Crashing Wave Throw</a>"]
    sledgehammer_fist_punch --> crashing_wave_throw

    heaven_thunder_hammer["<a class='internal-link' href='#Heaven Thunder Hammer'>Heaven Thunder Hammer</a>"]
    sledgehammer_fist_punch ----> heaven_thunder_hammer

    shockwave_technique["<a class='internal-link' href='#Shockwave Technique'>Shockwave Technique</a>"]
    crashing_wave_throw --> shockwave_technique

    subgraph Castebook Dawn
        direction TB

        knockout_blow["<a class='internal-link' href='#Knockout Blow'>Knockout Blow</a>"]

        pounding_hammer_of_devastation_technique["<a class='internal-link' href='#Pounding Hammer of Devastation Technique'>Pounding Hammer<br>of Devastation Technique</a>"]

        adamantine_fists_of_battle["<a class='internal-link' href='#Adamantine Fists of Battle'>Adamantine Fists<br>of Battle</a>"]
    end
    ox_stunning_blow --> knockout_blow
    heaven_thunder_hammer --> pounding_hammer_of_devastation_technique
    heaven_thunder_hammer --> adamantine_fists_of_battle
    hammer_on_iron_technique --> adamantine_fists_of_battle

    subgraph Cult of the Illuminated
        inevitable_victory_meditation["<a class='internal-link' href='#Inevitable Victory Meditation'>Inevitable Victory<br>Meditation</a>"]
        irrepressible_bravery_tactic["<a class='internal-link' href='#Irrepressible Bravery Tactic'>Irrepressible Bravery<br>Tactic</a>"]
        dancing_with_strife_technique["<a class='internal-link' href='#Dancing with Strife Technique'>Dancing with Strife<br>Technique</a>"]
        supremacy_of_war_method["<a class='internal-link' href='#Supremacy of War Method'>Supremacy of War<br>Method</a>"]
        ascendant_battle_visage["<a class='internal-link' href='#Ascendant Battle Visage'>Ascendant Battle<br>Visage</a>"]

    end

    subgraph endurance[Endurance Charms]
        direction TB
    ...
    fist_of_iron_technique --> inevitable_victory_meditation
    thunderclap_rush_attack --> irrepressible_bravery_tactic
    irrepressible_bravery_tactic --> dancing_with_strife_technique
    inevitable_victory_meditation --> supremacy_of_war_method
    dancing_with_strife_technique --> supremacy_of_war_method
    supremacy_of_war_method --> ascendant_battle_visage
    bloodthirsty_sword_dancer_spirit --> ascendant_battle_visage
