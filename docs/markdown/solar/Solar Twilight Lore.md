...
flowchart TD
    ...
    integrity_protecting_prana["<a class='internal-link' href='#Integrity-Protecting Prana'>Integrity-Protecting Prana</a>"]

    chaos_repelling_pattern["<a class='internal-link' href='#Chaos-Repelling Pattern'>Chaos-Repelling Pattern</a>"]
    integrity_protecting_prana --> chaos_repelling_pattern

    wyld_shaping_technique["<a class='internal-link' href='#Wyld-Shaping Technique'>Wyld-Shaping Technique</a>"]
    chaos_repelling_pattern --> wyld_shaping_technique

    essence_lending_method["<a class='internal-link' href='#Essence-Lending Method'>Essence-Lending Method</a>"]

    will_bolstering_method["<a class='internal-link' href='#Will-Bolstering Method'>Will-Bolstering Method</a>"]
    essence_lending_method --> will_bolstering_method

    wound_accepting_technique["<a class='internal-link' href='#Wound-Accepting Technique'>Wound-Accepting<br>Technique</a>"]
    will_bolstering_method --> wound_accepting_technique

    power_awarding_prana["<a class='internal-link' href='#Power-Awarding Prana'>Power-Awarding Prana</a>"]
    wound_accepting_technique --> power_awarding_prana

    subgraph Castebook Twilight
        direction TB
        earth_firming_method["<a class='internal-link' href='#Earth-Firming Method'>Earth-Firming Method</a>"]

        injury_forcing_technique["<a class='internal-link' href='#Injury-Forcing Technique'>Injury-Forcing Technique</a>"]

        order_affirming_blow["<a class='internal-link' href='#Order-Affirming Blow'>Order-Affirming Blow</a>"]

        sorcery_conferring_contemplation["<a class='internal-link' href='#Sorcery-Conferring Contemplation'>Sorcery-Conferring<br>Contemplation</a>"]
    end
    ...
    subgraph Castebook Night
        brewing_venom_technique["<a class='internal-link' href='#Brewing Venom Technique'>Brewing Venom Technique</a>"]

        envenomed_weapon_prana["<a class='internal-link' href='#Envenomed Weapon Prana'>Envenomed Weapon Prana</a>"]

        mastery_of_poison_technique["<a class='internal-link' href='#Mastery-of-Poison Technique'>Mastery-of-Poison Technique</a>"]
    end
