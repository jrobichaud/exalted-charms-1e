...
flowchart TD
    ...
    blurred_form_style["<a class='internal-link' href='#Blurred Form Style'>Blurred Form Style</a>"]
    invisible_statue_spirit --> blurred_form_style

    sound_and_scent_banishing_attitude["<a class='internal-link' href='#Sound and Scent-Banishing Attitude'>Sound and Scent Banishing<br>Attitude</a>"]
    blurred_form_style --> sound_and_scent_banishing_attitude

    subgraph Castebook Night
        unseen_ghost_walk["<a class='internal-link' href='#Cost: 7 motes, 1 Willpower'>Unseen Ghost Walk</a>"]
    end
