...
flowchart TD
    ...
    frugal_merchant_method["<a class='internal-link' href='#Frugal Merchant Method'>Frugal Merchant Method</a>"]

    insightful_buyer_technique["<a class='internal-link' href='#Insightful Buyer Technique'>Insightful Buyer Technique</a>"]
    frugal_merchant_method --> insightful_buyer_technique

    consumer_evaluating_glance["<a class='internal-link' href='#Consumer-Evaluating Glance'>Consumer-Evaluating<br>Glance</a>"]
    frugal_merchant_method --> consumer_evaluating_glance

    irresistable_salesman_spirit["<a class='internal-link' href='#Irresistable Salesman Spirit'>Irresistable Salesman<br>Spirit</a>"]
...
flowchart TD
    ...
    subgraph Castebook Eclipse
        bureaucratic_concealment_technique["<a class='internal-link' href='#Bureaucratic Concealment Technique'>Bureaucratic Concealment<br>Technique</a>"]

        forgetful_bureau_charm["<a class='internal-link' href='#Forgetful Bureau Charm'>Forgetful Bureau Charm</a>"]
    end
