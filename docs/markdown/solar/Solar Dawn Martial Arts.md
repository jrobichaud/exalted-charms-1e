...
flowchart TD
    ...
    striking_cobra_technique["<a class='internal-link' href='#Striking Cobra Technique'>Striking Cobra Technique</a>"]

    serpentine_evasion["<a class='internal-link' href='#Serpentine Evasion'>Serpentine Evasion</a>"]
    striking_cobra_technique --> serpentine_evasion

    snake_form["<a class='internal-link' href='#Snake Form'>Snake Form</a>"]
    serpentine_evasion --> snake_form

    essence_fangs_and_scales_technique["<a class='internal-link' href='#Essence Fangs and Scales Technique'>Essence Fangs and<br>Scales Technique</a>"]
    snake_form --> essence_fangs_and_scales_technique

    armor_penetrating_fang_strike["<a class='internal-link' href='#Armor-Penetrating Fang Strike'>Armor-Penetrating<br>Fang Strike</a>"]
    essence_fangs_and_scales_technique --> armor_penetrating_fang_strike

    snake_strikes_the_heel["<a class='internal-link' href='#Snake Strikes the Heel'>Snake Strikes the Heel</a>"]
    snake_form --> snake_strikes_the_heel

    crippling_pressure_point_strike["<a class='internal-link' href='#Crippling Pressure-Point Strike'>Crippling Pressure-Point<br> Strike</a>"]
    snake_strikes_the_heel --> crippling_pressure_point_strike

    uncoiling_serpent_prana["<a class='internal-link' href='#Uncoiling Serpent Prana'>Uncoiling Serpent Prana</a>"]
    snake_form --> uncoiling_serpent_prana

    striking_serpent_speed["<a class='internal-link' href='#Striking Serpent Speed'>Striking Serpent Speed</a>"]
    uncoiling_serpent_prana --> striking_serpent_speed
    essence_venom_strike["<a class='internal-link' href='#Essence Venom Strike'>Essence Venom Strike</a>"]
...
flowchart TD
    ...
    subgraph Castebook Dawn
        direction TB
        crimson_leaping_cat_technique["<a class='internal-link' href='#Crimson Leaping Cat Technique'>Crimson Leaping<br>Cat Technique</a>"]

        striking_fury_claws_attack["<a class='internal-link' href='#Striking Fury Claws Attack'>Striking Fury<br>Claws Attack</a>"]

        tiger_form["<a class='internal-link' href='#Tiger Form'>Tiger Form</a>"]

        raging_tiger_pounce["<a class='internal-link' href='#Raging Tiger Pounce'>Raging Tiger Pounce</a>"]
        spine_shattering_bite["<a class='internal-link' href='#Spine Shattering Bite'>Spine Shattering Bite</a>"]

        stalking_cat_movement_meditation["<a class='internal-link' href='#Stalking Cat Movement Meditation'>Stalking Cat<br>Movement Meditation</a>"]

        leap_from_cloaking_shadows_attack["<a class='internal-link' href='#Leap from Cloaking Shadows Attack'>Leap from Cloaking<br>Shadows Attack</a>"]

        celestial_tiger_hide["<a class='internal-link' href='#Celestial Tiger Hide'>Celestial Tiger Hide</a>"]

        angry_predator_frenzy_style["<a class='internal-link' href='#Angry Predator Frenzy Style'>Angry Predator<br>Frenzy Style</a>"]
...
flowchart TD
    ...
    subgraph Castebook Night
        image_of_death_technique["<a class='internal-link' href='#Image of Death Technique'>Image of Death Technique</a>"]

        wall_climbing_technique["<a class='internal-link' href='#Wall-Climbing Technique'>Wall-Climbing Technique</a>"]

        distracting_finger_gesture_attack["<a class='internal-link' href='#Distracting Finger-Gesture Attack'>Distracting Finger-Gesture Attack</a>"]

        ebon_shadow_form["<a class='internal-link' href='#Ebon Shadow Form'>Ebon Shadow Form</a>"]

        seven_point_of_weakness_strike["<a class='internal-link' href='#Seven Points of Weakness Strike'>Seven Points of Weakness Strike</a>"]

        limb_immobilizing_method["<a class='internal-link' href='#Limb-Immobilizing Method'>Limb-Immobilizing Method</a>"]

        paralyzing_touch_attack["<a class='internal-link' href='#Paralyzing Touch Attack'>Paralyzing Touch Attack</a>"]

        elusive_flicker_evasion["<a class='internal-link' href='#Elusive Flicker Evasion'>Elusive Flicker Evasion</a>"]

        blow_concealing_gesture_technique["<a class='internal-link' href='#Blow-Concealing Gesture Technique'>Blow-Concealing Gesture Technique</a>"]

        shadow_body_style["<a class='internal-link' href='#Shadow Body Style'>Shadow Body Style</a>"]

        shadow_stepping_motion["<a class='internal-link' href='#Shadow-Stepping Motion'>Shadow-Stepping Motion</a>"]
    end
...
flowchart TD
    ...
    subgraph Castebook Eclipse
        leaping_mantis_technique["<a class='internal-link' href='#Leaping Mantis Technique'>Leaping Mantis Technique</a>"]
        iron_arm_block["<a class='internal-link' href='#Iron Arm Block'>Iron Arm Block</a>"]

        mantis_form["<a class='internal-link' href='#Mantis Form'>Mantis Form</a>"]

        grasping_claw_method["<a class='internal-link' href='#Grasping Claw Method'>Grasping Claw Method</a>"]

        grasping_mantis_defense["<a class='internal-link' href='#Grasping Mantis Defense'>Grasping Mantis Defense</a>"]

        joint_locking_technique["<a class='internal-link' href='#Joint-Locking Technique'>Joint-Locking Technique</a>"]

        joint_breaking_attack["<a class='internal-link' href='#Joint-Breaking Attack'>Joint-Breaking Attack</a>"]

        flying_mantis_kick["<a class='internal-link' href='#Flying Mantis Kick'>Flying Mantis Kick</a>"]

        crushing_claw_technique["<a class='internal-link' href='#Crushing Claw Technique'>Crushing Claw Technique</a>"]

        unfolding_retribution_stance["<a class='internal-link' href='#Unfolding Retribution Stance'>Unfolding Retribution Stance</a>"]
    end
...
flowchart TD
    ...
    subgraph Cult of the Illuminated
        living_shield_technique["<a class='internal-link' href='#Living Shield Technique'>Living Shield<br>Technique</a>"]

        undefended_assault_method["<a class='internal-link' href='#Undefended Assault Method'>Undefended Assault<br>Method</a>"]

        dual_scarlet_blossom_technique["<a class='internal-link' href='#Dual Scarlet Blossom Technique'>Dual Scarlet Blossom<br>Technique</a>"]

        falling_blossom_form["<a class='internal-link' href='#Falling Blossom Form'>Falling Blossom<br>Form</a>"]

        purity_of_purpose_attack["<a class='internal-link' href='#Purity of Purpose Attack'>Purity of Purpose<br>Attack</a>"]
        strength_of_faith_meditation["<a class='internal-link' href='#Strength of Faith Meditation'>Strength of Faith<br>Meditation</a>"]

        verse_of_the_martyr["<a class='internal-link' href='#Verse of the Martyr'>Verse of the Martyr</a>"]

    end

    living_shield_technique --> undefended_assault_method
    living_shield_technique --> dual_scarlet_blossom_technique
    undefended_assault_method --> falling_blossom_form
    dual_scarlet_blossom_technique --> falling_blossom_form
    falling_blossom_form --> purity_of_purpose_attack
    falling_blossom_form --> strength_of_faith_meditation
    purity_of_purpose_attack --> verse_of_the_martyr
    strength_of_faith_meditation --> verse_of_the_martyr
