...
flowchart TD
    ...
    sensory_acuity_prana["<a class='internal-link' href='#Sensory Acuity Prana'>Sensory Acuity Prana</a>"]

    keen_sense_technique["<a class='internal-link' href='#Keen (Sense) Technique'>Keen (Sense)<br>Technique</a>"]
    sensory_acuity_prana --> keen_sense_technique

    unsurpassed_sense_discipline["<a class='internal-link' href='#Unsurpassed (Sense) Discipline'>Unsurpassed (Sense)<br>Discipline</a>"]
    keen_sense_technique --> unsurpassed_sense_discipline

    surprise_anticipation_method["<a class='internal-link' href='#Surprise Anticipation Method'>Surprise Anticipation<br>Method</a>"]
    ...
    subgraph savage_seas[Savage Seas]
        ...
        hundred_leagues_sight_procedure["<a class='internal-link' href='#Hundred Leagues Sight Procedure'>Hundred Leagues<br>Sight Procedure</a>"]
    end
    ...
    subgraph Castebook Night
        owl_eye_technique["<a class='internal-link' href='#Owl-Eye Technique'>Owl-Eye Technique</a>"]

        barrier_bypassing_senses["<a class='internal-link' href='#Barrier-Bypassing Senses'>Barrier-Bypassing<br>Senses</a>"]

        eye_of_the_unconquered_sun["<a class='internal-link' href='#Eye of the Unconquered Sun'>Eye of the<br>Unconquered Sun</a>"]
    end
