...
flowchart TD
    ...
    reed_in_the_wind["<a class='internal-link' href='#Reed in the Wind'>Reed in the Wind</a>"]

    shadow_over_water["<a class='internal-link' href='#Shadow Over Water'>Shadow Over Water</a>"]
    reed_in_the_wind --> shadow_over_water

    seven_shadow_evasion["<a class='internal-link' href='#Seven Shadow Evasion'>Seven Shadow Evasion</a>"]
    shadow_over_water --> seven_shadow_evasion

    reflex_sidestep_technique["<a class='internal-link' href='#Reflex Sidestep Technique'>Reflex Sidestep Technique</a>"]
    reed_in_the_wind --> reflex_sidestep_technique

    flow_like_blood["<a class='internal-link' href='#Flow Like Blood'>Flow Like Blood</a>"]
    reflex_sidestep_technique --> flow_like_blood
    seven_shadow_evasion --> flow_like_blood

    subgraph Castebook Night
        leaping_dodge_method["<a class='internal-link' href='#Leaping Dodge Method'>Leaping Dodge Method</a>"]
    end
