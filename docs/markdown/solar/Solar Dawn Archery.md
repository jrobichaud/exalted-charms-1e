...
flowchart TD
    ...
    wise_arrow["<a class='internal-link' href='#Wise Arrow'>Wise Arrow</a>"]

    sight_without_eyes["<a class='internal-link' href='#Sight Without Eyes'>Sight Without Eyes</a>"]
    wise_arrow ----> sight_without_eyes


    accuracy_without_distance["<a class='internal-link' href='#Accuracy Without Distance'>Accuracy Without Distance</a>"]
    sight_without_eyes --> accuracy_without_distance

    there_is_no_wind["<a class='internal-link' href='#There Is No Wind'>There Is No Wind</a>"]
    sight_without_eyes ---> there_is_no_wind

    trance_of_unhesitating_speed["<a class='internal-link' href='#Trance of Unhesitating Speed'>Trance of<br>Unhesitating Speed</a>"]
    wise_arrow --> trance_of_unhesitating_speed

    arrow_storm_technique["<a class='internal-link' href='#Arrow Storm Technique'>Arrow Storm Technique</a>"]
    trance_of_unhesitating_speed --> arrow_storm_technique

    fiery_arrow_attack["<a class='internal-link' href='#Fiery Arrow Attack'>Fiery Arrow Attack</a>"]

    dazzling_flare_attack["<a class='internal-link' href='#Dazzling Flare Attack'>Dazzling Flare Attack</a>"]
    fiery_arrow_attack --> dazzling_flare_attack

    phantom_arrow_technique["<a class='internal-link' href='#Phantom Arrow Technique'>Phantom Arrow Technique</a>"]
    fiery_arrow_attack --> phantom_arrow_technique

    solar_spike["<a class='internal-link' href='#Solar Spike'>Solar Spike</a>"]
    phantom_arrow_technique --> solar_spike

    immaculate_golden_bow["<a class='internal-link' href='#Immaculate Golden Bow'>Immaculate Golden Bow</a>"]
    solar_spike ---> immaculate_golden_bow

    rain_of_feathered_death["<a class='internal-link' href='#Rain of Feathered Death'>Rain of<br>Feathered Death</a>"]
    ...
    subgraph Castebook Dawn
        ...
        bolt_of_fiery_devastation_technique["<a class='internal-link' href='#Bolt of Fiery Devastation Technique'>Bolt of Fiery<br>Devastation Technique</a>"]

        inexhausible_bolts_of_solar_fire["<a class='internal-link' href='#Inexhaustible Bolts of Solar Fire'>Inexhaustible Bolts<br>of Solar Fire</a>"]

        shoot_without_distance_exercise["<a class='internal-link' href='#Shoot Without Distance Exercise'>Shoot Without Distance<br>Exercise</a>"]
    end
