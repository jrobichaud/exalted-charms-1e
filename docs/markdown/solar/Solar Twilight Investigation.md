...
flowchart TD
    ...
    ten_magistrate_eyes["<a class='internal-link' href='#Ten Magistrate Eyes'>Ten Magistrate Eyes</a>"]
    ...
    irresistable_questioning_technique["<a class='internal-link' href='#Irresistible Questioning Technique'>Irresistible Questioning<br>Technique</a>"]

    unknown_wisdow_epiphany["<a class='internal-link' href='#Unknown Wisdom Epiphany'>Unknown Wisdom Epiphany</a>"]

    subgraph Castebook Twilight
        direction TB
        abiding_blood_observation["<a class='internal-link' href='#Abiding Blood Observation'>Abiding Blood<br>Observation</a>"]

        hawk_aloft_gaze["<a class='internal-link' href='#Hawk Aloft Gaze'>Hawk Aloft Gaze</a>"]
        guilt_finding_inquisitor_method["<a class='internal-link' href='#Guilt-Finding Inquisitor Method'>Guilt-Finding<br>Inquisitor Method</a>"]
    end

    subgraph Castebook Night
        death_revealing_method["<a class='internal-link' href='#Death-Revealing Method'>Death-Revealing Method</a>"]
    end
