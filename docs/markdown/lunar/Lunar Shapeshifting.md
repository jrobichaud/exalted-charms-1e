...
flowchart TD
    ...
    hide_of_the_cunning_hunter["<a class='internal-link' href='#Hide of the Cunning Hunter'>🌙 Hide of the Cunning Hunter</a>"]

    masking_the_brilliant_form["<a class='internal-link' href='#Masking the Brilliant Form'>🌙 Masking the Brilliant Form</a>"]
...
flowchart LR
    ...
    subgraph Shapeshifting
        ...
        towering_beast_form["<a class='internal-link' href='#Towering Beast Form'>🌙 Towering Beast Form</a>"]

        humble_mouse_shape["<a class='internal-link' href='#Humble Mouse Shape'>🌙 Humble Mouse Shape</a>"]
        ...
        wondrous_lunar_transformation["<a class='internal-link' href='#Wondrous Lunar Transformation'>🌙 Wondrous Lunar<br>Transformation</a>"]

        shaping_the_once_living_form["<a class='internal-link' href='#Shaping the Once-Living Form'>🌙 Shaping the Once-Living Form</a>"]

        fish_tail_technique["<a class='internal-link' href='#Fish Tail Technique'>🌙 Fish Tail Technique</a>"]

        tool_hand_technique["<a class='internal-link' href='#Tool-Hand Technique'>🌙 Tool-Hand Technique</a>"]

        rat_head_technique["<a class='internal-link' href='#Rat-Head Technique'>🌙 Rat-Head Technique</a>"]
    end
    ...
    subgraph Body Enhancement
        ...
        crouching_tiger_exercise["<a class='internal-link' href='#Crouching Tiger Exercise'>🌙 Crouching Tiger Exercise</a>"]

        moonsilver_monkey_exercise["<a class='internal-link' href='#Moonsilver Monkey Exercise'>🌙 Moonsilver Monkey Exercise</a>"]

        regaining_breath_exercise["<a class='internal-link' href='#Regaining Breath Exercise'>🌑 Regaining Breath Exercise</a>"]

        breath_drinking_executioner_attack["<a class='internal-link' href='#Breath-Drinking Executioner Attack'>🌑 Breath-Drinking Executioner Attack</a>"]

        predator_grace_method["<a class='internal-link' href='#Predator Grace Method'>🌕 Predator Grace Method</a>"]

        panther_stride_stance["<a class='internal-link' href='#Panther Stride Stance'>🌙 Panther Stride Stance</a>"]

        flying_tiger_technique["<a class='internal-link' href='#Flying Tiger Technique'>🌙 Flying Tiger Technique</a>"]

        cat_falling_attitude["<a class='internal-link' href='#Cat-Falling Attitude'>🌕 Cat-Falling Attitude</a>"]

        tree_dwelling_jaguar_claws["<a class='internal-link' href='#Tree-Dwelling Jaguar Claws'>🌕 Tree-Dwelling Jaguar Claws</a>"]

        cat_paw_climbing_style["<a class='internal-link' href='#Cat-Paw Climbing Style'>🌕 Cat Paw Climbing Style</a>"]
    end
