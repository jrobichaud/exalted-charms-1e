...
flowchart LR
    ...
    sensing_the_deadly_flow["<a class='internal-link' href='#Sensing the Deadly Flow'>🌕 Sensing the Deadly Flow</a>"]

    striking_mospid_method["<a class='internal-link' href='#Striking Mospid Method'>🌕 Striking Mospid Method</a>"]
    sensing_the_deadly_flow --> striking_mospid_method

    ferocious_biting_sword["<a class='internal-link' href='#Ferocious Biting Sword'>🌕 Ferocious Biting Sword</a>"]
    striking_mospid_method --> ferocious_biting_sword

    dance_of_the_living_blade["<a class='internal-link' href='#Dance of the Living Blade'>🌕 Dance of the Living Blade</a>"]
    striking_mospid_method --> dance_of_the_living_blade

    irresistible_storm_attack["<a class='internal-link' href='#Irresistible Storm Attack'>🌕 Irresistible Storm Attack</a>"]
    dance_of_the_living_blade --> irresistible_storm_attack

    spinning_blade_attack["<a class='internal-link' href='#Spinning Blade Attack'>🌕 Spinning Blade Attack</a>"]
    dance_of_the_living_blade --> spinning_blade_attack

    lighting_sword_method["<a class='internal-link' href='#Lighting Sword Method'>🌕 Lighting Sword Method</a>"]
    spinning_blade_attack --> lighting_sword_method

    dust_devil_advance["<a class='internal-link' href='#Dust Devil Advance'>🌕 Dust Devil Advance</a>"]
    spinning_blade_attack --> dust_devil_advance

    twisting_surprise_attack["<a class='internal-link' href='#Twisting Surprise Attack'>🌙 Twisting Surprise Attack</a>"]
    striking_mospid_method --> twisting_surprise_attack

    foe_driving_attack["<a class='internal-link' href='#Foe-Driving Attack'>🌙 Foe-Driving Attack</a>"]
    twisting_surprise_attack --> foe_driving_attack

    monkey_paw_advance["<a class='internal-link' href='#Monkey Paw Advance'>🌙 Monkey Paw Advance</a>"]
    sensing_the_deadly_flow --> monkey_paw_advance

    weapon_clutching_method["<a class='internal-link' href='#Weapon-Clutching Method'>🌙 Weapon-Clutching Method</a>"]
    monkey_paw_advance --> weapon_clutching_method

    twisting_monkey_wrist["<a class='internal-link' href='#Twisting Monkey Wrist'>🌙 Twisting Monkey Wrist</a>"]
    weapon_clutching_method --> twisting_monkey_wrist

    surprising_gibbon_attack["<a class='internal-link' href='#Surprising Gibbon Attack'>🌙 Surprising Gibbon Attack</a>"]
    monkey_paw_advance --> surprising_gibbon_attack

    knowing_weapon_technique["<a class='internal-link' href='#Knowing Weapon Technique'>🌕 Knowing Weapon Technique</a>"]
    sensing_the_deadly_flow --> knowing_weapon_technique

    tiger_claw_swat["<a class='internal-link' href='#Tiger Claw Swat'>🌕 Tiger Claw Swat</a>"]
    sensing_the_deadly_flow --> tiger_claw_swat

    scar_making_blow["<a class='internal-link' href='#Scar-Making Blow'>🌕 Scar-Making Blow</a>"]
    tiger_claw_swat --> scar_making_blow

    ferocious_avalanche_technique["<a class='internal-link' href='#Ferocious Avalanche Technique'>🌕 Ferocious Avalanche Technique</a>"]
    tiger_claw_swat --> ferocious_avalanche_technique

    limb_maiming_flourish["<a class='internal-link' href='#Limb-Maiming Flourish'>🌕 Limb-Maiming Flourish</a>"]
    ferocious_avalanche_technique --> limb_maiming_flourish

    thunderclap_method["<a class='internal-link' href='#Thunderclap Method'>🌕 Thunderclap Method</a>"]
    tiger_claw_swat --> thunderclap_method

    weapon_fusion_method["<a class='internal-link' href='#Weapon Fusion Method'>🌕 Weapon Fusion Method</a>"]
    sensing_the_deadly_flow --> weapon_fusion_method

    weapon_shaping_prana["<a class='internal-link' href='#Weapon-Shaping Prana'>🌑 Weapon-Shaping Prana</a>"]
    weapon_fusion_method --> weapon_shaping_prana

    stunning_moonsilver_blow["<a class='internal-link' href='#Stunning Moonsilver Blow'>🌙 Stunning Moonsilver Blow</a>"]
    weapon_fusion_method --> stunning_moonsilver_blow

    surprising_moonsilver_deformation["<a class='internal-link' href='#Surprising Moonsilver Deformation'>🌙 Surprising Moonsilver Deformation</a>"]
    stunning_moonsilver_blow --> surprising_moonsilver_deformation

    deadly_moonsilver_affinity["<a class='internal-link' href='#Deadly Moonsilver Affinity'>🌙 Deadly Moonsilver Affinity</a>"]
    stunning_moonsilver_blow --> deadly_moonsilver_affinity

    insidious_moonsilver_shards["<a class='internal-link' href='#Insidious Moonsilver Shards'>🌙 Insidious Moonsilver Shards</a>"]
