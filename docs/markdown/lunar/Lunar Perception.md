...
flowchart LR
    ...
    sense_sharpening_change["<a class='internal-link' href='#Sense-Sharpening Change'>🌑 Sense-Sharpening Change</a>"]

    heightened_sense_methods["<a class='internal-link' href='#Heightened (Sense) Methods'>🌑 Heightened (Sense) Methods</a>"]
    sense_sharpening_change --> heightened_sense_methods

    subgraph interaction_and_knowledge[Interaction and Knowledge Charms]
        direction TB
        pack_forming_presence["<a class='internal-link' href='#... 🌙 Pack-Forming Presence'>... 🌙 Pack-Forming Presence</a>"]
    end

    sense_borrowing_method["<a class='internal-link' href='#Sense-Borrowing Method'>🌑 Sense-Borrowing Method</a>"]
    sense_sharpening_change --> sense_borrowing_method
    pack_forming_presence --> sense_borrowing_method

    ever_wary_fox_technique["<a class='internal-link' href='#Ever-Wary Fox Technique'>🌑 Ever-Wary Fox Technique</a>"]
    sense_sharpening_change --> ever_wary_fox_technique

    observed_prey_instinct["<a class='internal-link' href='#Observed Prey Instinct'>🌑 Observed Prey Instinct</a>"]
    ever_wary_fox_technique --> observed_prey_instinct

    weather_scenting_method["<a class='internal-link' href='#Weather-Scenting Method'>🌑 Weather-Scenting Method</a>"]
    ever_wary_fox_technique --> weather_scenting_method

    unerring_earth_direction_sense["<a class='internal-link' href='#Unerring Earth-Direction Sense'>🌑 Unerring Earth-Direction Sense</a>"]
    sense_sharpening_change --> unerring_earth_direction_sense

    moonsilver_scenting_sense["<a class='internal-link' href='#Moonsilver-Scenting Sense'>🌑 Moonsilver-Scenting Sense</a>"]
    unerring_earth_direction_sense --> moonsilver_scenting_sense

    wyld_sensing_instincts["<a class='internal-link' href='#Wyld-Sensing Instincts'>🌑 Wyld-Sensing Instincts</a>"]
    ever_wary_fox_technique --> wyld_sensing_instincts

    resisting_the_lure_of_madness["<a class='internal-link' href='#Resisting the Lure of Madness'>🌑 Resisting the Lure of Madness</a>"]
    wyld_sensing_instincts --> resisting_the_lure_of_madness

    wyld_object_appraisal_method["<a class='internal-link' href='#Wyld-Object Appraisal Method'>🌑 Wyld-Object Appraisal Method</a>"]
    wyld_sensing_instincts --> wyld_object_appraisal_method

    subgraph shapeshifting[Shapeshifting Charms]
        direction TB
        wondrous_lunar_transformation["<a class='internal-link' href='#... 🌙 Wondrous Lunar Transformation'>... 🌙 Wondrous Lunar Transformation</a>"]
    end

    harmony_with_reality_technique["<a class='internal-link' href='#Harmony with Reality'>🌑 Harmony with Reality Technique</a>"]
    wyld_object_appraisal_method --> harmony_with_reality_technique
    wondrous_lunar_transformation --> harmony_with_reality_technique

    ritual_of_lunar_stability["<a class='internal-link' href='#Ritual of Lunar Stability'>🌑 Ritual of Lunar Stability</a>"]
    harmony_with_reality_technique --> ritual_of_lunar_stability

    fish_eye_technique["<a class='internal-link' href='#Fish-Eye Technique'>🌙 Fish-Eye Technique</a>"]
    heightened_sense_methods -->|Sight| fish_eye_technique

    night_is_day["<a class='internal-link' href='#Night Is Day'>🌑 Night Is Day</a>"]
    heightened_sense_methods -->|Sight| night_is_day

    perceiving_the_hidden_world["<a class='internal-link' href='#Perceiving the Hidden World'>🌑 Perceiving the Hidden World</a>"]
    night_is_day --> perceiving_the_hidden_world

    comprehending_ears_meditation["<a class='internal-link' href='#Comprehending-Ears Meditation'>🌑 Comprehending-Ears Meditation</a>"]
    heightened_sense_methods -->|Hearing and Touch| comprehending_ears_meditation

    calls_of_the_human_prey["<a class='internal-link' href='#Calls of the Human Prey'>🌑 Calls of the Human Prey</a>"]
    comprehending_ears_meditation --> calls_of_the_human_prey

    feral_ears_metamorphosis["<a class='internal-link' href='#Feral-Ears Metamorphosis'>🌑 Feral-Ears Metamorphosis</a>"]
    comprehending_ears_meditation --> feral_ears_metamorphosis

    rabbit_ear_method["<a class='internal-link' href='#Rabbit-Ear Method'>🌑 Rabbit-Ear Method</a>"]
    heightened_sense_methods -->|Hearing and Touch| rabbit_ear_method

    seeing_without_looking["<a class='internal-link' href='#Seeing Without Looking'>🌑 Seeing Without Looking</a>"]
    rabbit_ear_method --> seeing_without_looking

    blood_kin_sense["<a class='internal-link' href='#Blood-Kin Sense'>🌑 Blood-Kin Sense</a>"]
    heightened_sense_methods -->|Smell and Taste| blood_kin_sense

    blood_on_the_wind["<a class='internal-link' href='#Blood on the Wind'>🌑 Blood on the Wind</a>"]
    heightened_sense_methods -->|Smell and Taste| blood_on_the_wind

    emotion_revealing_scent["<a class='internal-link' href='#Emotion-Revealing Scent'>🌑 Emotion-Revealing Scent</a>"]
    heightened_sense_methods -->|Smell and Taste| emotion_revealing_scent

    truth_scenting_method["<a class='internal-link' href='#Truth-Scenting Method'>🌑 Truth-Scenting Method</a>"]
