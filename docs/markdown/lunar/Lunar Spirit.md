...
flowchart TD
    ...
    spirit_scenting_technique["<a class='internal-link' href='#Spirit-Scenting Technique'>🌑 Spirit-Scenting Technique</a>"]

    pulse_of_the_invisible["<a class='internal-link' href='#Pulse of the Invisible'>🌑 Pulse of the Invisible</a>"]
    spirit_scenting_technique --> pulse_of_the_invisible

    devil_restraining_grip["<a class='internal-link' href='#Devil-Restraining Grip'>🌑 Devil-Restraining Grip</a>"]
    spirit_scenting_technique --> devil_restraining_grip

    spirit_maiming_essence_attack["<a class='internal-link' href='#Spirit-Maiming Essence Attack'>🌑 Spirit-Maiming Essence Attack</a>"]
