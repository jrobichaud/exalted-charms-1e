...
flowchart LR
    ...
    beast_instinct_method["<a class='internal-link' href='#Beast Instinct Method'>🌑 Beast Instinct Method</a>"]

    whale_breath_technique["<a class='internal-link' href='#Whale-Breath Technique'>🌕 Whale-Breath Technique</a>"]
    beast_instinct_method --> whale_breath_technique

    gill_breathing_technique["<a class='internal-link' href='#Gill-Breathing Technique'>🌙 Gill-Breathing Technique</a>"]
    whale_breath_technique --> gill_breathing_technique

    sealskin_endurance["<a class='internal-link' href='#Sealskin Endurance'>🌕 Sealskin Endurance</a>"]
    beast_instinct_method --> sealskin_endurance

    heat_adapting_method["<a class='internal-link' href='#Heat-Adapting Method'>🌕 Heat-Adapting Method</a>"]
    beast_instinct_method --> heat_adapting_method

    fire_walking_prana["<a class='internal-link' href='#Fire-Walking Prana'>🌕 Fire-Walking Prana</a>"]
    heat_adapting_method --> fire_walking_prana

    unerring_den_finding_sense["<a class='internal-link' href='#Unerring Den-Finding Sense'>🌑 Unerring Den-Finding Sense</a>"]
    beast_instinct_method --> unerring_den_finding_sense

    food_scenting_method["<a class='internal-link' href='#Food-Scenting Method'>🌕 Food-Scenting Method</a>"]
    beast_instinct_method --> food_scenting_method

    water_providing_technique["<a class='internal-link' href='#Water-Providing Technique'>🌑 Water-Providing Technique</a>"]
    beast_instinct_method --> water_providing_technique

    wolf_endurance_method["<a class='internal-link' href='#Wolf-Endurance Method'>🌕 Wolf-Endurance Method</a>"]
    food_scenting_method --> wolf_endurance_method
    water_providing_technique --> wolf_endurance_method

    bear_sleep_technique["<a class='internal-link' href='#Bear-Sleep Technique'>🌕 Bear-Sleep Technique</a>"]
    wolf_endurance_method --> bear_sleep_technique

    fortitude_of_the_aurochs["<a class='internal-link' href='#Fortitude of the Aurochs'>🌕 Fortitude of the Aurochs</a>"]
    wolf_endurance_method --> fortitude_of_the_aurochs

    ever_waking_method["<a class='internal-link' href='#Ever-Waking Method'>🌕 Ever-Waking Method</a>"]
    wolf_endurance_method --> ever_waking_method

    pain_numbing_prana["<a class='internal-link' href='#Pain-Numbing Prana'>🌕 Pain-Numbing Prana</a>"]
    ...
    disease_purging_essence["<a class='internal-link' href='#Disease-Purging Essence'>🌕 Disease-Purging Essence</a>"]
    infection_resisting_method --> disease_purging_essence

    bruise_relief_technique["<a class='internal-link' href='#Bruise Relief Technique'>🌕 Bruise Relief Technique</a>"]
    infection_resisting_method --> bruise_relief_technique

    halting_the_scarlet_flow["<a class='internal-link' href='#Halting the Scarlet Flow'>🌕 Halting the Scarlet Flow</a>"]
