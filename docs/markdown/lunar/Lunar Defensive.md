...
flowchart LR
    ...
    steel_paw_style["<a class='internal-link' href='#Steel Paw Style'>🌕 Steel Paw Style</a>"]

    ground_denying_defense["<a class='internal-link' href='#Ground-Denying Defense'>🌕 Ground-Denying Defense</a>"]
    steel_paw_style --> ground_denying_defense

    golden_tiger_block["<a class='internal-link' href='#Golden Tiger Block'>🌕 Golden Tiger Block</a>"]
    steel_paw_style --> golden_tiger_block

    wary_swallow_method["<a class='internal-link' href='#Wary Swallow Method'>🌑 Wary Swallow Method</a>"]
    golden_tiger_block --> wary_swallow_method

    feline_guard_technique["<a class='internal-link' href='#Feline Guard Technique'>🌕 Feline Guard Technique</a>"]
    steel_paw_style --> feline_guard_technique

    den_mother_method["<a class='internal-link' href='#Den-Mother Method'>🌕 Den-Mother Method</a>"]
    feline_guard_technique --> den_mother_method

    crouching_tiger_stance["<a class='internal-link' href='#Crouching Tiger Stance'>🌕 Crouching Tiger Stance</a>"]
    feline_guard_technique --> crouching_tiger_stance

    bowing_reed_technique["<a class='internal-link' href='#Bowing Reed Technique'>🌕 Bowing Reed Technique</a>"]

    bending_before_the_storm["<a class='internal-link' href='#Bending Before the Storm'>🌕 Bending Before the Storm</a>"]
    bowing_reed_technique --> bending_before_the_storm

    wind_dancing_technique["<a class='internal-link' href='#Wind-Dancing Technique'>🌕 Wind-Dancing Technique</a>"]
    bending_before_the_storm --> wind_dancing_technique

    serpent_eye_defense["<a class='internal-link' href='#Serpent-Eye Defense'>🌕 Serpent-Eye Defense</a>"]
    bowing_reed_technique --> serpent_eye_defense

    unmoving_bear_defense["<a class='internal-link' href='#Unmoving Bear Defense'>🌕 Unmoving Bear Defense</a>"]
    bowing_reed_technique --> unmoving_bear_defense

    foot_trapping_counter["<a class='internal-link' href='#Foot-Trapping Counter'>🌕 Foot-Trapping Counter</a>"]
    unmoving_bear_defense --> foot_trapping_counter

    flowing_body_evasion["<a class='internal-link' href='#Flowing Body Evasion'>🌙 Flowing Body Evasion</a>"]
    unmoving_bear_defense --> flowing_body_evasion

    pack_saving_method["<a class='internal-link' href='#Pack-Saving Method'>🌕 Pack-Saving Method</a>"]
    unmoving_bear_defense --> pack_saving_method

    running_through_the_herd["<a class='internal-link' href='#Running Through the Herd'>🌙 Running Through the Herd</a>"]
    flowing_body_evasion --> running_through_the_herd
    pack_saving_method --> running_through_the_herd

    hide_toughning_essence["<a class='internal-link' href='#Hide Toughening Essence'>🌕 Hide Toughening Essence</a>"]

    armor_forming_technique["<a class='internal-link' href='#Armor-Forming Technique'>🌕 Armor-Forming Technique</a>"]
    hide_toughning_essence --> armor_forming_technique

    limb_shielding_growth["<a class='internal-link' href='#Limb-Shielding Growth'>🌕 Limb-Shielding Growth</a>"]
    hide_toughning_essence --> limb_shielding_growth

    scales_of_the_dragon["<a class='internal-link' href='#Scales of the Dragon'>🌕 Scales of the Dragon</a>"]
    armor_forming_technique --> scales_of_the_dragon

    invulnerable_moonsilver_carapace["<a class='internal-link' href='#Invulnerable Moonsilver Carapace'>🌕 Invulnerable Moonsilver Carapace</a>"]
