...
flowchart LR
    ...
    tale_spinning_mastery["<a class='internal-link' href='#Tale-Spinning Mastery'>🌙 Tale-Spinning Mastery</a>"]

    lore_speaking_method["<a class='internal-link' href='#Lore-Speaking Method'>🌑 Lore-Speaking Method</a>"]
    tale_spinning_mastery --> lore_speaking_method

    divining_the_hidden_truth["<a class='internal-link' href='#Divining the Hidden Truth'>🌑 Divining the Hidden Truth</a>"]
    lore_speaking_method --> divining_the_hidden_truth

    lion_roar_method["<a class='internal-link' href='#Lion-Roar Method'>🌙 Lion-Roar Method</a>"]
    tale_spinning_mastery --> lion_roar_method

    wind_speaking_method["<a class='internal-link' href='#Wind-Speaking Method'>🌑 Wind-Speaking Method</a>"]
    lion_roar_method --> wind_speaking_method

    river_of_words["<a class='internal-link' href='#River of Words'>🌑 River of Words</a>"]
    wind_speaking_method --> river_of_words

    emotion_shaping_technique["<a class='internal-link' href='#Emotion-Shaping Technique'>🌙 Emotion-Shaping Technique</a>"]
    tale_spinning_mastery --> emotion_shaping_technique

    crowd_inciting_method["<a class='internal-link' href='#Crowd-Inciting Method'>🌙 Crowd-Inciting Method</a>"]
    emotion_shaping_technique --> crowd_inciting_method

    crowd_calming_pronouncement["<a class='internal-link' href='#Crowd-Calming Pronouncement'>🌙 Crowd-Calming Pronouncement</a>"]
    crowd_inciting_method --> crowd_calming_pronouncement

    courage_building_address["<a class='internal-link' href='#Courage-Building Address'>🌙 Courage-Building Address</a>"]
    crowd_calming_pronouncement --> courage_building_address

    glorious_battle_presence["<a class='internal-link' href='#Glorious Battle Presence'>🌙 Glorious Battle Presence</a>"]
    courage_building_address --> glorious_battle_presence

    foe_taunting_utterance["<a class='internal-link' href='#Foe-Taunting Utterance'>🌙 Foe-Taunting Utterance</a>"]
    emotion_shaping_technique --> foe_taunting_utterance

    glib_tongue_technique["<a class='internal-link' href='#Glib-Tongue Technique'>🌙 Glib-Tongue Technique</a>"]
    foe_taunting_utterance --> glib_tongue_technique

    imposing_presence_attitude["<a class='internal-link' href='#Imposing Presence Attitude'>🌙 Imposing Presence Attitude</a>"]
    emotion_shaping_technique --> imposing_presence_attitude

    fearful_lunar_form["<a class='internal-link' href='#Fearful Lunar Form'>🌙 Fearful Lunar Form</a>"]
    imposing_presence_attitude --> fearful_lunar_form

    mind_blanking_fear_technique["<a class='internal-link' href='#Mind-Blanking Fear Technique'>🌙 Mind-Blanking Fear Technique</a>"]
    fearful_lunar_form --> mind_blanking_fear_technique

    unspeaking_aura_of_dread["<a class='internal-link' href='#Unspeaking Aura of Dread'>🌙 Unspeaking Aura of Dread</a>"]

    beast_calming_method["<a class='internal-link' href='#Beast-Calming Method'>🌙 Beast-Calming Method</a>"]
    ...
    subgraph perception[Perception Charms]
        direction TB
    ...
    attention_demanding_presence["<a class='internal-link' href='#Attention-Demanding Presence'>🌙 Attention-Demanding Presence</a>"]
    unspeaking_aura_of_dread --> attention_demanding_presence

    animal_magnetism["<a class='internal-link' href='#Animal Magnetism'>🌙 Animal Magnetism</a>"]
    attention_demanding_presence --> animal_magnetism

    brotherhood_of_lake_and_river["<a class='internal-link' href='#Brotherhood of Lake and River'>🌑 Brotherhood of Lake and River</a>"]

    blood_singing_instincts["<a class='internal-link' href='#Blood-Singing Instincts'>🌕 Blood-Singing Instincts</a>"]
    brotherhood_of_lake_and_river --> blood_singing_instincts

    pack_calling_cry["<a class='internal-link' href='#Pack-Calling Cry'>🌙 Pack-Calling Cry</a>"]
