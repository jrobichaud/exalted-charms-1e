...
flowchart TB
    ...
    silver_waterfall_technique["<a class='internal-link' href='#Silver Waterfall Technique'>🌕 Silver Waterfall Technique</a>"]
    ...
    skillful_ricochet_attack["<a class='internal-link' href='#Skillful Ricochet Attack'>🌑 Skillful Ricochet Attack</a>"]
    knowing_the_arrows_path --> skillful_ricochet_attack

    subgraph melee_combat[Melee Combat Charms]
        direction TB
        shaping_the_once_living_form["<a class='internal-link' href='#... 🌙 Shaping the Once-Living Form'>... 🌙 Shaping the Once-Living Form</a>"]
    end

    arrow_shaping_method["<a class='internal-link' href='#Arrow-Shaping Method'>🌙 Arrow-Shaping Method</a>"]
    natures_harmony_advantage --> arrow_shaping_method
    shaping_the_once_living_form --> arrow_shaping_method

    wolf_eye_advantage["<a class='internal-link' href='#Wolf Eye Advantage'>🌑 Wolf Eye Advantage</a>"]
    eagle_eye_advantage --> wolf_eye_advantage

    wind_wings_carry_technique["<a class='internal-link' href='#Wind-Wings Carry Technique'>🌑 Wind-Wings Carry Technique</a>"]
    wolf_eye_advantage --> wind_wings_carry_technique

    bow_bending_method["<a class='internal-link' href='#Bow-Bending Method'>🌕 Bow-Bending Method</a>"]
    ...
    riding_the_secret_wind["<a class='internal-link' href='#Riding the Secret Wind'>🌑 Riding the Secret Wind</a>"]
