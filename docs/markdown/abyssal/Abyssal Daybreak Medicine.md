...
flowchart TD
    ...
    infallible_ailment_sense["<a class='internal-link' href='#Infallible Ailment Sense'>Infallible Ailment Sense</a>"]

    contamination_of_form["<a class='internal-link' href='#Contamination of (Form)'>Contamination of (Form)</a>"]
    infallible_ailment_sense --> contamination_of_form

    rampant_pestilence_method["<a class='internal-link' href='#Rampant Pestilence Method'>Rampant Pestilence Method</a>"]
    contamination_of_form --> |Body| rampant_pestilence_method

    taint_extraction_method["<a class='internal-link' href='#Taint Extraction Method'>Taint Extraction Method</a>"]
    contamination_of_form --> |Body| taint_extraction_method

    unsurpassed_plague_kiss["<a class='internal-link' href='#Unsurpassed Plague Kiss'>Unsurpassed Plague Kiss</a>"]
    ...
    flesh_mending_discipline["<a class='internal-link' href='#Flesh-Mending Discipline'>Flesh-Mending Discipline</a>"]

    blood_mastery_technique["<a class='internal-link' href='#Blood Mastery Technique'>Blood Mastery Technique</a>"]
    flesh_mending_discipline ---> blood_mastery_technique

    touch_of_gentle_repose["<a class='internal-link' href='#Touch of Gentle Repose'>Touch of Gentle Repose</a>"]
    flesh_mending_discipline --> touch_of_gentle_repose

    crimson_waterfall_attack["<a class='internal-link' href='#Crimson Waterfall Attack'>Crimson Waterfall Attack</a>"]
    blood_mastery_technique --> crimson_waterfall_attack

    winter_strikes_the_forest["<a class='internal-link' href='#Winter Strikes the Forest'>Winter Strikes the Forest</a>"]
    crimson_waterfall_attack --> winter_strikes_the_forest

    wound_absorbing_method["<a class='internal-link' href='#Wound-Absorbing Method'>Wound-Absorbing Method</a>"]
    touch_of_gentle_repose --> wound_absorbing_method
    blood_mastery_technique --> wound_absorbing_method

    fivefold_wound_absorbing_method["<a class='internal-link' href='#Fivefold Wound-Absorbing Method'>Fivefold Wound-Absorbing Method</a>"]
    wound_absorbing_method --> fivefold_wound_absorbing_method


    subgraph craft[Craft Charms]
        direction TB
        bone_graft_technique["<a class='internal-link' href='#Bone Graft Technique'>Bone Graft Technique</a>"]
    end
