...
flowchart TD
    ...
    ghost_armor_prana["<a class='internal-link' href='#Ghost Armor Prana'>Ghost Armor Prana</a>"]

    tireless_sentinel_technique["<a class='internal-link' href='#Tireless Sentinel Technique'>Tireless Sentinel Technique</a>"]
    ghost_armor_prana --> tireless_sentinel_technique

    relentless_revenant_spirit["<a class='internal-link' href='#Relentless Revenant Spirit'>Relentless Revenant Spirit</a>"]
    tireless_sentinel_technique --> relentless_revenant_spirit

    pain_eating_focus["<a class='internal-link' href='#Pain-Eating Focus'>Pain-Eating Focus</a>"]

    insensible_corpse_technique["<a class='internal-link' href='#Insensible Corpse Technique'>Insensible Corpse Technique</a>"]
    pain_eating_focus --> insensible_corpse_technique

    agony_savoring_spirit["<a class='internal-link' href='#Agony-Savoring Spirit'>Agony-Savoring Spirit</a>"]
