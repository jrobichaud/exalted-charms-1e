...
flowchart TD
    ...
    hungry_missile_technique["<a class='internal-link' href='#Hungry Missile Technique'>Hungry Missile Technique</a>"]

    lighting_clutch_of_the_raptor["<a class='internal-link' href='#Lighting Clutch of the Raptor'>Lighting Clutch of the Raptor</a>"]
    hungry_missile_technique --> lighting_clutch_of_the_raptor

    incomparable_assassin_method["<a class='internal-link' href='#Incomparable Assassin Method'>Incomparable Assassin Method</a>"]
    hungry_missile_technique ---> incomparable_assassin_method

    aid_of_ill_wind["<a class='internal-link' href='#Aid of Ill Wind'>Aid of Ill Wind</a>"]

    ivory_spine_attack["<a class='internal-link' href='#Ivory Spine Attack'>Ivory Spine Attack</a>"]
    aid_of_ill_wind ----> ivory_spine_attack

    thousand_needle_torrent["<a class='internal-link' href='#Thousand Needle Torrent'>Thousand Needle Torrent</a>"]
    ivory_spine_attack --> thousand_needle_torrent

    burrowing_bone_maggot["<a class='internal-link' href='#Burrowing Bone Maggot'>Burrowing Bone Maggot</a>"]
    ivory_spine_attack --> burrowing_bone_maggot

    pitiless_scything_razor["<a class='internal-link' href='#Pitiless Scything Razor'>Pitiless Scything Razor</a>"]
    incomparable_assassin_method --> pitiless_scything_razor
    aid_of_ill_wind --> pitiless_scything_razor

    ravening_crimson_chakram["<a class='internal-link' href='#Ravening Crimson Chakram'>Ravening Crimson Chakram</a>"]
...
normal, so the Charm is not an all-or-nothing proposition.
...
disperses harmlessly against her palm.
