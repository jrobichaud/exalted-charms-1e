...
flowchart TD
    ...
    authority_eroding_technique["<a class='internal-link' href='#Authority-Eroding Technique'>Authority-Eroding Technique</a>"]

    argument_slaying_remark["<a class='internal-link' href='#Argument-Slaying Remark'>Argument-Slaying Remark</a>"]
    authority_eroding_technique --> argument_slaying_remark

    alluring_eloquence_method["<a class='internal-link' href='#Alluring Eloquence Method'>Alluring Eloquence Method</a>"]
    argument_slaying_remark --> alluring_eloquence_method

    corruption_sensing_scrutiny["<a class='internal-link' href='#Corruption-Sensing Scrutiny'>Corruption-Sensing Scrutiny</a>"]

    cunning_subversion_style["<a class='internal-link' href='#Cunning Subversion Style'>Cunning Subversion Style</a>"]
    corruption_sensing_scrutiny --> cunning_subversion_style

    regime_toppling_insinuation["<a class='internal-link' href='#Regime-Toppling Insinuation'>Regime-Toppling Insinuation</a>"]
    cunning_subversion_style --> regime_toppling_insinuation

    iron_tyrant_mien["<a class='internal-link' href='#Iron Tyrant Mien'>Iron Tyrant Mien</a>"]
