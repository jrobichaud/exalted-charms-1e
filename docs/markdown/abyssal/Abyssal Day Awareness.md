...
flowchart TD
    ...
    fivefold_sensory_exercise["<a class='internal-link' href='#Fivefold Sensory Exercise'>Fivefold Sensory Exercise</a>"]

    sense_eroding_gesture["<a class='internal-link' href='#Sense-Eroding Gesture'>Sense-Eroding Gesture</a>"]
    fivefold_sensory_exercise --> sense_eroding_gesture

    ominous_portent_method["<a class='internal-link' href='#Ominous Portent Method'>Ominous Portent Method</a>"]
    fivefold_sensory_exercise --> ominous_portent_method

    superior_sense_focus["<a class='internal-link' href='#Superior (Sense) Focus'>Superior (Sense) Focus</a>"]
    fivefold_sensory_exercise ---> superior_sense_focus

    owl_eyes_treatment["<a class='internal-link' href='#Owl Eyes Treatment'>Owl Eyes Treatment</a>"]
    superior_sense_focus --> |Sight| owl_eyes_treatment

    incomparable_sense_technique["<a class='internal-link' href='#Incomparable (Sense) Technique'>Incomparable (Sense) Technique</a>"]
