...
flowchart TD
    ...
    inescapable_iron_grip["<a class='internal-link' href='#Inescapable Iron Grip'>Inescapable Iron Grip</a>"]
    dead_mans_grasp ---> inescapable_iron_grip

    owl_seizes_mouse["<a class='internal-link' href='#Owl Seizes Mouse'>Owl Seizes Mouse</a>"]
    inescapable_iron_grip --> owl_seizes_mouse

    ravaging_strike["<a class='internal-link' href='#Ravaging Strike'>Ravaging Strike</a>"]

    scouring_erosion_method["<a class='internal-link' href='#Scouring Erosion Method'>Scouring Erosion Method</a>"]
    ravaging_strike --> scouring_erosion_method

    lashing_tempest_attack["<a class='internal-link' href='#Lashing Tempest Attack'>Lashing Tempest Attack</a>"]
    ravaging_strike --> lashing_tempest_attack

    bone_shattering_fist["<a class='internal-link' href='#Bone-Shattering Fist'>Bone-Shattering Fist</a>"]
    lashing_tempest_attack --> bone_shattering_fist

    five_knife_strike["<a class='internal-link' href='#Five Knife Strike'>Five Knife Strike</a>"]
    lashing_tempest_attack ---> five_knife_strike

    blood_drinking_palm["<a class='internal-link' href='#Blood-Drinking Palm'>Blood-Drinking Palm</a>"]
    five_knife_strike --> blood_drinking_palm

    writhing_blood_chain_technique["<a class='internal-link' href='#Writhing Blood Chain Technique'>Writhing Blood Chain Technique</a>"]
