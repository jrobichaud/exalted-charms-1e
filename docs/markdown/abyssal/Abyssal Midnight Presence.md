...
flowchart TD
    ...
    skeleton_summoning_gesture["<a class='internal-link' href='#Skeleton Summoning Gesture'>Skeleton Summoning Gesture</a>"]
    command_the_dead --> skeleton_summoning_gesture

    irresistible_succubus_style["<a class='internal-link' href='#Irresistible Succubus Style'>Irresistible Succubus Style</a>"]
    elegant_tyrants_majesty ----> irresistible_succubus_style

    soul_flaying_gaze["<a class='internal-link' href='#Soul-Flaying Gaze'>Soul-Flaying Gaze</a>"]
    elegant_tyrants_majesty -----> soul_flaying_gaze

    compelling_whisper_technique["<a class='internal-link' href='#Compelling Whisper Technique'>Compelling Whisper Technique</a>"]
    soul_flaying_gaze --> compelling_whisper_technique

    heart_stopping_mien["<a class='internal-link' href='#Heart-Stopping Mien'>Heart-Stopping Mien</a>"]
