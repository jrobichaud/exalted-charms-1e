...
flowchart TD
    ...
    fault_finding_scrutiny["<a class='internal-link' href='#Fault-Finding Scrutiny'>Fault-Finding Scrutiny</a>"]

    material_withering_method["<a class='internal-link' href='#(Material) Withering Method'>(Material) Withering Method</a>"]
    fault_finding_scrutiny --> material_withering_method

    decay_resistance_preparation["<a class='internal-link' href='#Decay Resistance Preparation'>Decay Resistance Preparation</a>"]
    fault_finding_scrutiny --> decay_resistance_preparation

    subgraph medicine[Medicine Charms]
        direction TB
        flesh_mending_technique["<a class='internal-link' href='#Flesh-Mending Technique'>Flesh-Mending Technique</a>"]
    end
    ...
    form_restoring_touch["<a class='internal-link' href='#Form-Restoring Touch'>Form-Restoring Touch</a>"]
