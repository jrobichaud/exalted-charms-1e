...
flowchart TD
    ...
    bloodthirsty_arrow["<a class='internal-link' href='#Bloodthirsty Arrow'>Bloodthirsty Arrow</a>"]

    twisting_spiteful_shaft["<a class='internal-link' href='#Twisting Spiteful Shaft'>Twisting Spiteful Shaft</a>"]
    bloodthirsty_arrow --> twisting_spiteful_shaft

    hundred_paces_bite["<a class='internal-link' href='#Hundred Paces Bite'>Hundred Paces Bite</a>"]
    twisting_spiteful_shaft --> hundred_paces_bite

    pulse_of_the_prey["<a class='internal-link' href='#Pulse of the Prey'>Pulse of the Prey</a>"]
    bloodthirsty_arrow --> pulse_of_the_prey

    flawless_archer_discipline["<a class='internal-link' href='#Flawless Archer Discipline'>Flawless Archer Discipline</a>"]
    pulse_of_the_prey --> flawless_archer_discipline

    withering_feathered_maelstrom["<a class='internal-link' href='#Withering Feathered Maelstrom'>Withering Feathered Maelstrom</a>"]
    flawless_archer_discipline --> withering_feathered_maelstrom

    iron_sleet_attack["<a class='internal-link' href='#Iron Sleet Attack'>Iron Sleet Attack</a>"]

    relic_arrow_method["<a class='internal-link' href='#Relic Arrow Method'>Relic Arrow Method</a>"]
    iron_sleet_attack --> relic_arrow_method

    splinter_of_the_void["<a class='internal-link' href='#Splinter of the Void'>Splinter of the Void</a>"]
    relic_arrow_method --> splinter_of_the_void

    exquisite_relic_bow["<a class='internal-link' href='#Exquisite Relic Bow'>Exquisite Relic Bow</a>"]
    relic_arrow_method --> exquisite_relic_bow

    piercing_ghost_barb["<a class='internal-link' href='#Piercing Ghost Barb'>Piercing Ghost Barb</a>"]
