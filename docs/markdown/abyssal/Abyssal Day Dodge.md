...
flowchart TD
    ...
    flitting_shadow_form["<a class='internal-link' href='#Flitting Shadow Form'>Flitting Shadow Form</a>"]

    uncanny_impulse_evasion["<a class='internal-link' href='#Uncanny Impulse Evasion'>Uncanny Impulse Evasion</a>"]
    flitting_shadow_form --> uncanny_impulse_evasion

    fivefold_shadow_form["<a class='internal-link' href='#Fivefold Shadow Form'>Fivefold Shadow Form</a>"]
    flitting_shadow_form --> fivefold_shadow_form

    flickering_wisp_technique["<a class='internal-link' href='#Flickering Wisp Technique'>Flickering Wisp Technique</a>"]
    fivefold_shadow_form --> flickering_wisp_technique

    flowing_evasion_assault["<a class='internal-link' href='#Flowing Evasion Assault'>Flowing Evasion Assault</a>"]
    flickering_wisp_technique --> flowing_evasion_assault

    incomparable_phantom_form["<a class='internal-link' href='#Incomparable Phantom Form'>Incomparable Phantom Form</a>"]
