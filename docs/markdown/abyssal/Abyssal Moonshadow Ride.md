...
flowchart TD
    ...
    soul_reins["<a class='internal-link' href='#Soul Reins'>Soul Reins</a>"]

    mount_breaking_method["<a class='internal-link' href='#Mount-Breaking Method'>Mount-Breaking Method</a>"]
    soul_reins --> mount_breaking_method

    tireless_charger_technique["<a class='internal-link' href='#Tireless Charger Technique'>Tireless Charger Technique</a>"]
    mount_breaking_method --> tireless_charger_technique

    forceful_spirit_spur["<a class='internal-link' href='#Forceful Spirit Spur'>Forceful Spirit Spur</a>"]
    soul_reins --> forceful_spirit_spur

    spectral_steed["<a class='internal-link' href='#Spectral Steed'>Spectral Steed</a>"]
    forceful_spirit_spur --> spectral_steed

    mount_spooking_shout["<a class='internal-link' href='#Mount-Spooking Shout'>Mount-Spooking Shout</a>"]
    soul_reins --> mount_spooking_shout

    foundering_foal_gesture["<a class='internal-link' href='#Foundering Foal Gesture'>Foundering Foal Gesture</a>"]
