...
flowchart TD
    ...
    furious_blade["<a class='internal-link' href='#Furious Blade'>Furious Blade</a>"]

    savage_shade_style["<a class='internal-link' href='#Savage Shade Style'>Savage Shade Style</a>"]
    furious_blade --> savage_shade_style

    artful_maiming_onslaught["<a class='internal-link' href='#Artful Maiming Onslaught'>Artful Maiming Onslaught</a>"]
    savage_shade_style --> artful_maiming_onslaught

    slashing_ghost_talon["<a class='internal-link' href='#Slashing Ghost Talon'>Slashing Ghost Talon</a>"]
    furious_blade ----> slashing_ghost_talon

    crimson_banquet_method["<a class='internal-link' href='#Crimson Banquet Method'>Crimson Banquet Method</a>"]
    slashing_ghost_talon --> crimson_banquet_method

    reaper_of_men["<a class='internal-link' href='#Reaper of Men'>Reaper of Men</a>"]
    crimson_banquet_method --> reaper_of_men

    soul_searing_blow["<a class='internal-link' href='#Soul-Searing Blow'>Soul-Searing Blow</a>"]
    slashing_ghost_talon --> soul_searing_blow

    soul_cleaving_strike["<a class='internal-link' href='#Soul-Cleaving Strike'>Soul-Cleaving Strike</a>"]
    reaper_of_men --> soul_cleaving_strike
    soul_searing_blow --> soul_cleaving_strike

    five_shadow_feint["<a class='internal-link' href='#Five Shadow Feint'>Five Shadow Feint</a>"]
    furious_blade --------> five_shadow_feint

    ebon_lightning_prana["<a class='internal-link' href='#Ebony Lightning Prana'>Ebony Lightning Prana</a>"]
    five_shadow_feint --> ebon_lightning_prana

    unfurling_iron_lotus["<a class='internal-link' href='#Unfurling Iron Lotus'>Unfurling Iron Lotus</a>"]
    five_shadow_feint --> unfurling_iron_lotus

    glorious_carnage_typhoon["<a class='internal-link' href='#Glorious Carnage Typhoon'>Glorious Carnage Typhoon</a>"]
    unfurling_iron_lotus --> glorious_carnage_typhoon

    blade_summoning_gesture["<a class='internal-link' href='#Blade-Summoning Gesture'>Blade-Summoning Gesture</a>"]

    thieving_raiton_claws["<a class='internal-link' href='#Thieving Raiton Claws'>Thieving Raiton Claws</a>"]
    blade_summoning_gesture --> thieving_raiton_claws

    void_sheat_technique["<a class='internal-link' href='#Void Sheath Technique'>Void Sheath Technique</a>"]
    blade_summoning_gesture ---> void_sheat_technique

    resplendent_shadow_blade["<a class='internal-link' href='#Resplendent Shadow Blade'>Resplendent Shadow Blade</a>"]
    void_sheat_technique --> resplendent_shadow_blade

    elegant_flowing_deflection["<a class='internal-link' href='#Elegant Flowing Deflection'>Elegant Flowing Deflection</a>"]

    vengeful_riposte["<a class='internal-link' href='#Vengeful Riposte'>Vengeful Riposte</a>"]
    elegant_flowing_deflection --> vengeful_riposte

    corrosive_parry["<a class='internal-link' href='#Corrosive Parry'>Corrosive Parry</a>"]
    vengeful_riposte --> corrosive_parry

    attunement_shattering_block["<a class='internal-link' href='#Attunement-Shattering Block'>Attunement-Shattering Block</a>"]
    corrosive_parry --> attunement_shattering_block

    fluttering_moth_defense["<a class='internal-link' href='#Fluttering Moth Defense'>Fluttering Moth Defense</a>"]
    elegant_flowing_deflection -----> fluttering_moth_defense

    hundred_razor_circle["<a class='internal-link' href='#Hundred Razor Circles'>Hundred Razor Circles</a>"]
    fluttering_moth_defense --> hundred_razor_circle

    incomparable_sentinel_stance["<a class='internal-link' href='#Incomparable Sentinel Stance'>Incomparable Sentinel Stance</a>"]
    hundred_razor_circle --> incomparable_sentinel_stance

    eye_of_the_tempest["<a class='internal-link' href='#Eye of the Tempest'>Eye of the Tempest</a>"]
