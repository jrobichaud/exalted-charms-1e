...
flowchart TD
    ...
    spirit_hardened_frame["<a class='internal-link' href='#Spirit-Hardened Frame'>Spirit-Hardened Frame</a>"]

    ivory_blossom_carapace["<a class='internal-link' href='#Ivory Blossom Carapace'>Ivory Blossom Carapace</a>"]
    spirit_hardened_frame --> ivory_blossom_carapace

    bone_arsenal_method["<a class='internal-link' href='#Bone Arsenal Method'>Bone Arsenal Method</a>"]
    ivory_blossom_carapace --> bone_arsenal_method

    crimson_petal_armor["<a class='internal-link' href='#Crimson Petal Armor'>Crimson Petal Armor</a>"]
    ivory_blossom_carapace ---> crimson_petal_armor

    flowing_wound_defense["<a class='internal-link' href='#Flowing Wound Defense'>Flowing Wound Defense</a>"]
    crimson_petal_armor --> flowing_wound_defense

    plague_knows_its_master["<a class='internal-link' href='#Plague Knows Its Master'>Plague Knows Its Master</a>"]
    spirit_hardened_frame ------> plague_knows_its_master

    snake_bites_its_tail["<a class='internal-link' href='#Snake Bites Its Tail'>Snake Bites Its Tail</a>"]
    spirit_hardened_frame --> snake_bites_its_tail

    scarlet_venom_technique["<a class='internal-link' href='#Scarlet Venom Technique'>Scarlet Venom Technique</a>"]
    snake_bites_its_tail --> scarlet_venom_technique

    armor_calling_kata["<a class='internal-link' href='#Armor-Calling Kata'>Armor-Calling Kata</a>"]

    void_banished_mail["<a class='internal-link' href='#Void-Banished Mail'>Void-Banished Mail</a>"]
    armor_calling_kata --> void_banished_mail

    inauspiscious_shadow_plate["<a class='internal-link' href='#Inauspicious Shadow Plate'>Inauspicious Shadow Plate</a>"]
...
dice of lethal damage equal to his own Strength.
...
Cost: 1 mote per 1B/1L, 1 Willpower, one lethal
health level
Duration: One scene
Type: Simple
...
creator's body through his mouth.
