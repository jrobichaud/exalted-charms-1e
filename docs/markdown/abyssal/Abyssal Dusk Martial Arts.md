...
flowchart TD
    ...
    essence_discerning_glance["<a class='internal-link' href='#Essence Discerning Glance'>Essence Discerning Glance</a>"]

    shrouded_claw_attack["<a class='internal-link' href='#Shrouded Claw Attack'>Shrouded Claw Attack</a>"]
    essence_discerning_glance --> shrouded_claw_attack

    hungry_ghost_form["<a class='internal-link' href='#Hungry Ghost Form'>Hungry Ghost Form</a>"]
    shrouded_claw_attack --> hungry_ghost_form

    power_reaping_prana["<a class='internal-link' href='#Power Reaping Prana'>Power Reaping Prana</a>"]
    hungry_ghost_form --> power_reaping_prana

    charm_smothering_technique["<a class='internal-link' href='#Charm Smothering Technique'>Charm Smothering Technique</a>"]
    power_reaping_prana --> charm_smothering_technique

    consuming_entropy_strike["<a class='internal-link' href='#Consuming Entropy Strike'>Consuming Entropy Strike</a>"]
    hungry_ghost_form --> consuming_entropy_strike

    blood_freezing_technique["<a class='internal-link' href='#Blood Freezing Technique'>Blood Freezing Technique</a>"]
    consuming_entropy_strike --> blood_freezing_technique

    unnatural_shambling_deftness["<a class='internal-link' href='#Unnatural Shambling Deftness'>Unnatural Shambling Deftness</a>"]
    hungry_ghost_form --> unnatural_shambling_deftness

    lunging_phantom_method["<a class='internal-link' href='#Lunging Phantom Method'>Lunging Phantom Method</a>"]
    unnatural_shambling_deftness --> lunging_phantom_method

    soul_flaying_strike["<a class='internal-link' href='#Soul-Flaying Strike'>Soul-Flaying Strike</a>"]
...
successful reflexive Intelligence + Occult roll (difficulty 2).
