...
flowchart TD
    ...
    language_absorbing_method["<a class='internal-link' href='#Language Absorbing Method'>Language Absorbing Method</a>"]

    peerless_fluency_style["<a class='internal-link' href='#Peerless Fluency Style'>Peerless Fluency Style</a>"]
    language_absorbing_method --> peerless_fluency_style

    theft_of_words["<a class='internal-link' href='#Theft of Words'>Theft of Words</a>"]
    language_absorbing_method ----> theft_of_words

    confusing_of_tongues["<a class='internal-link' href='#Confusing of Tongues'>Confusing of Tongues</a>"]
    theft_of_words --> confusing_of_tongues

    words_of_beneath_a_whisper["<a class='internal-link' href='#Words of Beneath a Whisper'>Words of Beneath a Whisper</a>"]
    theft_of_words --> words_of_beneath_a_whisper

    blood_inscription_technique["<a class='internal-link' href='#Blood Inscription Technique'>Blood Inscription Technique</a>"]

    subgraph occult[Occult Charms]
        direction TB
        corpus_rending_blow["<a class='internal-link' href='#Corpus-Rending Blow'>Corpus-Rending Blow</a>"]
    end

    ghost_warding_glyph["<a class='internal-link' href='#Ghost-Warding Glyph'>Ghost-Warding Glyph</a>"]
    blood_inscription_technique --> ghost_warding_glyph
    corpus_rending_blow --> ghost_warding_glyph

    glyph_unveiling_meditation["<a class='internal-link' href='#Glyph-Unveiling Meditation'>Glyph-Unveiling Meditation</a>"]
    blood_inscription_technique ---> glyph_unveiling_meditation

    scathing_cynic_attitude["<a class='internal-link' href='#Scathing Cynic Attitude'>Scathing Cynic Attitude</a>"]
