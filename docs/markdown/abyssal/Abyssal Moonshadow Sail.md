...
flowchart TD
    ...
    crew_sustaining_technique["<a class='internal-link' href='#Crew Sustaining Technique'>Crew Sustaining Technique</a>"]
    ghost_on_the_deck --> crew_sustaining_technique

    phantom_sail_technique["<a class='internal-link' href='#Phantom Sail Technique'>Phantom Sail Technique</a>"]
    master_sailors_memory --> phantom_sail_technique

    ghost_wind_prana["<a class='internal-link' href='#Ghost Wind Prana'>Ghost Wind Prana</a>"]
    phantom_sail_technique --> ghost_wind_prana

    wind_killing_stance["<a class='internal-link' href='#Wind-Killing Stance'>Wind-Killing Stance</a>"]
    ghost_on_the_deck ---> wind_killing_stance
    ghost_wind_prana ---> wind_killing_stance

    hull_hardening_technique["<a class='internal-link' href='#Hull-Hardening Technique'>Hull-Hardening Technique</a>"]
    ghost_wind_prana --> hull_hardening_technique

    hull_restoring_meditation["<a class='internal-link' href='#Hull-Restoring Meditation'>Hull-Restoring Meditation</a>"]
    hull_hardening_technique --> hull_restoring_meditation

    unsinkable_derelict_preservation["<a class='internal-link' href='#Unsinkable Derelict Preservation'>Unsinkable Derelict Preservation</a>"]
