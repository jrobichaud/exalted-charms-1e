...
flowchart TD
    ...
    taste_the_demon_wind["<a class='internal-link' href='#Taste the Demon Wind'>Taste the Demon Wind</a>"]
    ...
    tame_the_wicked_appetite["<a class='internal-link' href='#Tame the Wicked Appetite'>Tame the Wicked Appetite</a>"]
    diversion_of_the_savage_hunger --> tame_the_wicked_appetite

    command_the_hungry_devil["<a class='internal-link' href='#Command the Hungry Devil'>Command the Hungry Devil</a>"]
    call_the_ravening_hound --> command_the_hungry_devil

    dust_commands_litany["<a class='internal-link' href='#Dust Commands Litany'>Dust Commands Litany</a>"]
    command_the_hungry_devil --> dust_commands_litany

    ghostly_harness_exercise["<a class='internal-link' href='#Ghostly Harness Exercise'>Ghostly Harness Exercise</a>"]
    tame_the_wicked_appetite --> ghostly_harness_exercise
    command_the_hungry_devil --> ghostly_harness_exercise

    spirit_handling_leash["<a class='internal-link' href='#Spirit Handling Leash'>Spirit Handling Leash</a>"]
