...
flowchart TD
    ...
    illuminate_the_shadow_constraint["<a class='internal-link' href='#Illuminate the Shadow Constraint'>Illuminate the Shadow Constraint</a>"]

    dark_sorcery_observation["<a class='internal-link' href='#Dark Sorcery Observation'>Dark Sorcery Observation</a>"]

    ghostly_magistrate_perception["<a class='internal-link' href='#Ghostly Magistrate Perception'>Ghostly Magistrate Perception</a>"]
    illuminate_the_shadow_constraint --> ghostly_magistrate_perception

    brief_exemption["<a class='internal-link' href='#Brief Exemption'>Brief Exemption</a>"]
    illuminate_the_shadow_constraint --> brief_exemption

    accept_amercement["<a class='internal-link' href='#Accept Amercement'>Accept Amercement</a>"]
    brief_exemption --> accept_amercement

    levy_fine["<a class='internal-link' href='#Levy Fine'>Levy Fine</a>"]
    accept_amercement --> levy_fine

    house_arrest["<a class='internal-link' href='#House Arrest'>House Arrest</a>"]
    levy_fine --> house_arrest

    hide_the_living_name["<a class='internal-link' href='#Hide the Living Name'>Hide the Living Name</a>"]
    house_arrest --> hide_the_living_name

    impose_stricture["<a class='internal-link' href='#Impose Stricture'>Impose Stricture</a>"]
    levy_fine --> impose_stricture

    curse_of_the_damned["<a class='internal-link' href='#Curse of the Damned'>Curse of the Damned</a>"]
