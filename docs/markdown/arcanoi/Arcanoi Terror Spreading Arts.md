...
flowchart TD
    ...
    corpse_fed_radiance["<a class='internal-link' href='#Corpse-Fed Radiance'>Corpse-Fed Radiance</a>"]

    black_breath_of_the_abyss["<a class='internal-link' href='#Black Breath of the Abyss'>Black Breath of the Abyss</a>"]
    corpse_fed_radiance --> black_breath_of_the_abyss

    painting_the_sunset_picture["<a class='internal-link' href='#Painting the Sunset Picture'>Painting the Sunset Picture</a>"]
    black_breath_of_the_abyss --> painting_the_sunset_picture

    midnight_canvas_unfurled["<a class='internal-link' href='#Midnight Canvas Unfurled'>Midnight Canvas Unfurled</a>"]
    painting_the_sunset_picture --> midnight_canvas_unfurled

    the_ichor_cauldron["<a class='internal-link' href='#The Ichor Cauldron'>The Ichor Cauldron</a>"]
    midnight_canvas_unfurled --> the_ichor_cauldron

    messenger_of_the_grave["<a class='internal-link' href='#Messenger of the Grave'>Messenger of the Grave</a>"]
    the_ichor_cauldron --> messenger_of_the_grave

    six_plague_summons["<a class='internal-link' href='#Six Plague Summons'>Six Plague Summons</a>"]
    messenger_of_the_grave --> six_plague_summons

    hand_of_the_wind["<a class='internal-link' href='#Hand of the Wind'>Hand of the Wind</a>"]
    corpse_fed_radiance --> hand_of_the_wind

    strike_of_dead_hands["<a class='internal-link' href='#Strike of Dead Hands'>Strike of Dead Hands</a>"]
    hand_of_the_wind --> strike_of_dead_hands

    ebon_grasp_of_oblivion["<a class='internal-link' href='#Ebon Grasp of Oblivion'>Ebon Grasp of Oblivion</a>"]
    black_breath_of_the_abyss --> ebon_grasp_of_oblivion
    strike_of_dead_hands --> ebon_grasp_of_oblivion

    flying_time_technique["<a class='internal-link' href='#Flying Time Technique'>Flying Time Technique</a>"]
    strike_of_dead_hands --> flying_time_technique

    subgraph Book of Bone and Ebony
        staggered_dark_stars_movement["<a class='internal-link' href='#Staggered Dark Stars Movement'>Staggered Dark Stars Movement</a>"]


        hours_like_autumn_leaves["<a class='internal-link' href='#Hours Like Autumn Leaves'>Hours Like Autumn Leaves</a>"]
    end
