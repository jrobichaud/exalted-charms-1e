...
flowchart TD
    ...
    jangling_coin_pouch_sense["<a class='internal-link' href='#Jangling Coin Pouch Sense'>Jangling Coin Pouch Sense</a>"]

    earnest_creditor_technique["<a class='internal-link' href='#Earnest Creditor Technique'>Earnest Creditor Technique</a>"]
    ...
    cannibal_call["<a class='internal-link' href='#Cannibal Call'>Cannibal Call</a>"]
    bold_thiefs_way --> cannibal_call

    secret_imperial_mint_technique["<a class='internal-link' href='#Secret Imperial Mint Technique'>Secret Imperial Mint Technique</a>"]
