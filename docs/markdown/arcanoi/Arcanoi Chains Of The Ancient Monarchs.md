...
flowchart TD
    ...
    snare_the_fleeing_thief["<a class='internal-link' href='#Snare the Fleeing Thief'>Snare the Fleeing Thief</a>"]
    essence_binding --> snare_the_fleeing_thief

    essence_lasso_form["<a class='internal-link' href='#Essence Lasso Form'>Essence Lasso Form</a>"]
    essence_binding --> essence_lasso_form

    net["<a class='internal-link' href='#Net'>Net</a>"]
