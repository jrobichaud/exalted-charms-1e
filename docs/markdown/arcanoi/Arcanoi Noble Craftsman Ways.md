...
flowchart TD
    ...
    soulsteel_scream["<a class='internal-link' href='#Soulsteel Scream'>Soulsteel Scream</a>"]

    soulsteel_shaper["<a class='internal-link' href='#Soulsteel Shaper'>Soulsteel Shaper</a>"]
    soulsteel_scream --> soulsteel_shaper

    grave_goods_shaping_technique["<a class='internal-link' href='#Grave Goods Shaping Technique'>Grave Goods Shaping Technique</a>"]
    soulsteel_shaper --> grave_goods_shaping_technique

    soulsteel_rebuilding_technique["<a class='internal-link' href='#Soulsteel Rebuilding Technique'>Soulsteel Rebuilding Technique</a>"]
