...
flowchart LR
    ...
    deadly_starmetal_offensive["<a class='internal-link' href='#Deadly Starmetal Offensive (JI)'>Deadly Starmetal Offensive (JI)</a>"]

    orichalcum_sheathing_stance["<a class='internal-link' href='#Orichalcum Sheathing Stance (PENG)'>Orichalcum Sheathing Stance (PENG)</a>"]

    flickering_moonsilver_approach["<a class='internal-link' href='#Flickering Moonsilver Approach (LU)'>Flickering Moonsilver Approach (LU)</a>"]

    five_jade_fury["<a class='internal-link' href='#Five Jade Fury (ZHOU)'>Five Jade Fury (ZHOU)</a>"]

    four_magical_materials_form["<a class='internal-link' href='#Four Magical Materials Form(HOU TUI)'>Four Magical Materials Form(HOU TUI)</a>"]
    ...
    charm_redirection_technique["<a class='internal-link' href='#Charm Redirection Technique(AN)'>Charm Redirection Technique(AN)</a>"]

    sequential_charm_disruption["<a class='internal-link' href='#Sequential Charm Disruption (CAJ)'>Sequential Charm Disruption (CAJ)</a>"]
    charm_redirection_technique --> sequential_charm_disruption

    spell_shattering_palm["<a class='internal-link' href='#Spell-Shattering Palm (LI)'>Spell-Shattering Palm (LI)</a>"]

    astrology_interruption_method["<a class='internal-link' href='#Astrology Interruption Method (HUA JI)'>Astrology Interruption Method (HUA JI)</a>"]

    soul_fire_shaper_form["<a class='internal-link' href='#Soul Fire Shaper Form (QIAN JING)'>Soul Fire Shaper Form (QIAN JING)</a>"]
    ...
    god_ways["<a class='internal-link' href='#God-Ways (ZUO GU)'>God-Ways (ZUO GU)</a>"]

    type_exalt_ways["<a class='internal-link' href='#(Type) Exalt Ways (YOU PAN)'>(Type) Exalt Ways (YOU PAN)</a>"]

    games_of_divinity_form["<a class='internal-link' href='#Games of Divinity Form (WU JI)'>Games of Divinity Form (WU JI)</a>"]
    god_ways --> games_of_divinity_form
    type_exalt_ways --> games_of_divinity_form

    demesne_emulation_practice["<a class='internal-link' href='#Demesne Emulation Practice (KAO)'>Demesne Emulation Practice (KAO)</a>"]

    demesne_and_manse_form["<a class='internal-link' href='#Demesne and Manse Form (CHUNG TING)'>Demesne and Manse Form (CHUNG TING)</a>"]
    demesne_emulation_practice --> demesne_and_manse_form

    prismatic_arrangement_of_creation["<a class='internal-link' href='#Prismatic Arrangement of Creation (TAO)'>Prismatic Arrangement of Creation (TAO)</a>"]
...
does not mimic the Essence of soulsteel.
...
damage one of the Five Magical Materials.
...
and AN and CAl and LI and HUA JI
...
annulling Charms are as follows:
...
action, unassisted by the Charm.
...
before the relevant attack resolves.
...
accidentally hide the wrong person.
...
Charm also represents his action for the turn.
...
## Sequential Charm Disruption (CAJ)
...
the Charms affected, plus 5 motes.
...
distraction roll (see Exalted, pp. 216-217).
...
trigger an inquiry by the bureau.
...
itself — cannot help but support her victory.
...
each time he invokes this Charm.
...
for even the most desperate of addicts.
Characters cannot normally use more than one
Martial Arts Form-type Charm at a time.
...
Sidereal terminates the Form, the Hearthstone fades.
...
Hearthstone's abilities appropriately.
Characters cannot normally use more than one
Martial Arts Form-type Charm at a time.


## Prismatic Arrangement of Creation (TAO)
...
roll, adding the Sidereal's Essence in automatic successes.
...
and embraces other Forms as lesser parts of itself.
