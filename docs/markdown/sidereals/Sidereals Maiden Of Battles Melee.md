...
flowchart TD
    ...
    harmony_of_blows["<a class='internal-link' href='#Harmony of Blows'>Harmony of Blows</a>"]

    meditation_on_war["<a class='internal-link' href='#Meditation on War'>Meditation on War</a>"]
    harmony_of_blows --> meditation_on_war

    orchestration_of_conflict["<a class='internal-link' href='#Orchestration of Conflict'>Orchestration of Conflict</a>"]
    harmony_of_blows --> orchestration_of_conflict

    impeding_the_flow["<a class='internal-link' href='#Impeding the Flow'>Impeding the Flow</a>"]

    serenity_in_blood["<a class='internal-link' href='#Serenity in Blood'>Serenity in Blood</a>"]
    harmony_of_blows --> serenity_in_blood
    impeding_the_flow --> serenity_in_blood

    smiling_at_the_damned["<a class='internal-link' href='#Smiling at the Damned'>Smiling at the Damned</a>"]

    perfection_of_the_visionary_warrior["<a class='internal-link' href='#Perfection of the Visionary Warrior'>Perfection of the Visionary Warrior</a>"]
