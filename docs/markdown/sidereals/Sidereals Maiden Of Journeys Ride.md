...
flowchart TD
    ...
    ordained_bridle_of_mercury["<a class='internal-link' href='#Ordained Bridle of Mercury'>Ordained Bridle of Mercury</a>"]

    spirit_shape_companion["<a class='internal-link' href='#Spirit-Shape Companion'>Spirit-Shape Companion</a>"]
    ordained_bridle_of_mercury --> spirit_shape_companion

    godly_companion["<a class='internal-link' href='#Godly Companion'>Godly Companion</a>"]
    spirit_shape_companion --> godly_companion

    breaking_the_wild_mortal["<a class='internal-link' href='#Breaking the Wild Mortal'>Breaking the Wild Mortal</a>"]
    ordained_bridle_of_mercury --> breaking_the_wild_mortal

    yellow_path["<a class='internal-link' href='#Yellow Path'>Yellow Path</a>"]

    glory_path["<a class='internal-link' href='#Glory Path'>Glory Path</a>"]
    yellow_path --> glory_path

    riding_the_dragon["<a class='internal-link' href='#Riding the Dragon'>Riding the Dragon</a>"]
