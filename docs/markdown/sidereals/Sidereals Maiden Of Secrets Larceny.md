...
flowchart TD
    ...
    creation_smuggling_procedures["<a class='internal-link' href='#Creation Smuggling Procedure'>Creation Smuggling Procedure</a>"]

    sidereal_shell_games["<a class='internal-link' href='#Sidereal Shell Games'>Sidereal Shell Games</a>"]
    creation_smuggling_procedures --> sidereal_shell_games

    name_pilfering_practices["<a class='internal-link' href='#Name Pilfering Practices'>Name Pilfering Practices</a>"]

    dream_confiscation_approach["<a class='internal-link' href='#Dream Confiscation Approach'>Dream Confiscation Approach</a>"]
    name_pilfering_practices --> dream_confiscation_approach

    honorable_thief_spirit["<a class='internal-link' href='#Honorable Thief Spirit'>Honorable Thief Spirit</a>"]

    conning_chaos_technique["<a class='internal-link' href='#Conning Chaos Technique'>Conning Chaos Technique</a>"]
