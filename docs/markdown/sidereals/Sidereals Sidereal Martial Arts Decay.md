...
flowchart TD
    ...
    feverish_essence_discharge_atemi["<a class='internal-link' href='#Feverish Essence Discharge Atemi'>Feverish Essence Discharge Atemi</a>"]

    disjointed_essence_infectious_atemi["<a class='internal-link' href='#Disjointed Essence Infectious Atemi'>Disjointed Essence Infectious Atemi</a>"]

    convulsive_displacement_infectious_atemi["<a class='internal-link' href='#Convulsive Displacement Infectious Atemi'>Convulsive Displacement Infectious Atemi</a>"]

    essence_disrupting_infectious_atemi["<a class='internal-link' href='#Essence Disrupting Infectious Atemi'>Essence Disrupting Infectious Atemi</a>"]
    ...
    perfect_reconstruction_method["<a class='internal-link' href='#Perfect Reconstruction Method'>Perfect Reconstruction Method</a>"]

    spirit_and_body_purification_touch["<a class='internal-link' href='#Spirit and Body Purification Touch'>Spirit and Body Purification Touch</a>"]

    inner_dragon_unbinding["<a class='internal-link' href='#Inner Dragon Unbinding'>Inner Dragon Unbinding</a>"]
    spirit_and_body_purification_touch --> inner_dragon_unbinding

    flare_of_invulnerability_method["<a class='internal-link' href='#Flare of Invulnerability Method'>Flare of Invulnerability Method</a>"]
    ...
    citrine_poxes_of_contagion_form["<a class='internal-link' href='#Citrine Poxes of Contagion Form'>Citrine Poxes of Contagion Form</a>"]
    ...
    spiritual_perfection["<a class='internal-link' href='#Spiritual Perfection'>Spiritual Perfection</a>"]
    citrine_poxes_of_contagion_form --> spiritual_perfection

    gentle_touch_of_the_wicked_hand["<a class='internal-link' href='#Gentle Touch of the Wicked Hand'>Gentle Touch of the Wicked Hand</a>"]
    spiritual_perfection --> gentle_touch_of_the_wicked_hand

    glorious_sidereal_protection["<a class='internal-link' href='#Glorious Sidereal Protection'>Glorious Sidereal Protection</a>"]
    spiritual_perfection --> glorious_sidereal_protection

    essence_shattering_typhoon["<a class='internal-link' href='#Essence-Shattering Typhoon'>Essence-Shattering Typhoon</a>"]
...
seeing sun no longer could sustain
...
inspiring greatness of the Unconquered Sun.
...
Sickness are wasted — the character does nothing.
...
out a lung, or some similar event transpires.
...
contracted cases of Jigsaw Organ Condition this Age.
The vector for this disease is unknown.
...
Arts attack supplemented by this Charm.
...
take advantage of this Charm to raise it further.)
• Any effect that has locked the target into an
undesired shape is instantly shattered.
...
broken, and all lingering effects disappear.
• The Sidereal Exalted can transfer as many motes
of his Essence to the target as desired.
• The Sidereal Exalted can transfer as many points
of his temporary Willpower to the target as desired.
...
difficulty 2. Again, the memory only lasts for a scene.
...
influence of the Wyld do not suffer from this effect.
...
arbitrary Third Circle illnesses.
