...
flowchart TD
    ...
    secrets_of_future_strife["<a class='internal-link' href='#Secret of Future Strife'>Secret of Future Strife</a>"]

    flight_of_mercury["<a class='internal-link' href='#Flight of Mercury'>Flight of Mercury</a>"]
    secrets_of_future_strife --> flight_of_mercury

    blade_of_the_battle_maiden["<a class='internal-link' href='#Blade of the Battle Maiden'>Blade of the Battle Maiden</a>"]
    ...
    death_parrying_stroke["<a class='internal-link' href='#Death-Parrying Stroke'>Death-Parrying Stroke</a>"]
    violet_bier_of_sorrows_form --> death_parrying_stroke

    life_severing_blow["<a class='internal-link' href='#Life-Severing Blow'>Life-Severing Blow</a>"]
    violet_bier_of_sorrows_form --> life_severing_blow

    metal_storm["<a class='internal-link' href='#Metal Storm'>Metal Storm</a>"]
    life_severing_blow --> metal_storm

    conclusion_pursuing_approach["<a class='internal-link' href='#Conclusion-Pursuing Approach'>Conclusion-Pursuing Approach</a>"]
