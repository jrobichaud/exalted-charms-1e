...
flowchart TD
    ...
    unnatural_many_step_stride["<a class='internal-link' href='#Unnatural Many-Step Stride'>Unnatural Many-Step Stride</a>"]

    dance_of_the_hungry_spider["<a class='internal-link' href='#Dance of the Hungry Spider'>Dance of the Hungry Spider</a>"]
    unnatural_many_step_stride --> dance_of_the_hungry_spider

    maw_of_dripping_venom["<a class='internal-link' href='#Maw of Dripping Venom'>Maw of Dripping Venom</a>"]

    rain_of_unseen_threads["<a class='internal-link' href='#Rain of Unseen Threads'>Rain of Unseen Threads</a>"]
    ...
    cannibalistic_heritage_technique["<a class='internal-link' href='#Cannibalistic Heritage Technique'>Cannibalistic Heritage Technique</a>"]
    charcoal_march_of_spiders_form --> cannibalistic_heritage_technique

    thumbnail_spider_march["<a class='internal-link' href='#Thumbnail Spider March'>Thumbnail Spider March</a>"]
    cannibalistic_heritage_technique --> thumbnail_spider_march

    jumping_spider_strike["<a class='internal-link' href='#Jumping Spider Strike'>Jumping Spider Strike</a>"]
    cannibalistic_heritage_technique --> jumping_spider_strike

    water_spider_bite["<a class='internal-link' href='#Water Spider Bite'>Water Spider Bite</a>"]
    cannibalistic_heritage_technique --> water_spider_bite

    pattern_spider_touch["<a class='internal-link' href='#Pattern Spider Touch'>Pattern Spider Touch</a>"]
    ...
    grandmother_spider_mastery["<a class='internal-link' href='#Grandmother Spider Mastery'>Grandmother Spider Mastery</a>"]
