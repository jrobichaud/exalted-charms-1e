...
flowchart TD
    ...
    willful_weapon_method["<a class='internal-link' href='#Willful Weapon Method'>Willful Weapon Method</a>"]

    life_gets_worse_approach["<a class='internal-link' href='#Life Gets Worse Approach'>Life Gets Worse Approach</a>"]

    essence_thorn_practice["<a class='internal-link' href='#Essence Thorn Practice'>Essence Thorn Practice</a>"]
    life_gets_worse_approach --> essence_thorn_practice

    pain_amplification_stratagem["<a class='internal-link' href='#Pain Amplification Stratagem'>Pain Amplification Stratagem</a>"]

    unrelenting_torment_technique["<a class='internal-link' href='#Unrelenting Torment Technique'>Unrelenting Torment Technique</a>"]
...
(normally triple the listed range).
...
attack ignores range limitations on the weapon.
...
on this Charm, the shadow fades away.
...
the blade pulls him toward the target.
...
against the character's actions for that turn.
