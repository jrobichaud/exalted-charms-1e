...
flowchart TD
    ...
    generalized_ammunition_technique["<a class='internal-link' href='#Generalized Ammunition Technique'>Generalized Ammunition Technique</a>"]

    any_direction_arrow["<a class='internal-link' href='#Any-Direction Arrow'>Any-Direction Arrow</a>"]

    every_direction_arrow["<a class='internal-link' href='#Every-Direction Arrow'>Every-Direction Arrow</a>"]
    every_direction_arrow --> any_direction_arrow

    opportune_shot["<a class='internal-link' href='#Opportune Shot'>Opportune Shot</a>"]

    five_seasons_approach["<a class='internal-link' href='#Five Seasons Approach'>Five Seasons Approach</a>"]
    every_direction_arrow --> five_seasons_approach
    opportune_shot --> five_seasons_approach

    many_missiles_bow_technique["<a class='internal-link' href='#Many Missiles Bow Technique'>Many Missiles Bow Technique</a>"]
