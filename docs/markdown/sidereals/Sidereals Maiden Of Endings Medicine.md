...
flowchart TD
    ...
    smooth_transition["<a class='internal-link' href='#Smooth Transition'>Smooth Transition</a>"]

    peaceful_conclusion["<a class='internal-link' href='#Peaceful Conclusion'>Peaceful Conclusion</a>"]
    smooth_transition --> peaceful_conclusion

    invocation_of_the_storm_following_silence["<a class='internal-link' href='#Invocation of the Storm-Following Silence'>Invocation of the Storm-Following Silence</a>"]
    smooth_transition --> invocation_of_the_storm_following_silence

    terminate_illness["<a class='internal-link' href='#Terminate Illness'>Terminate Illness</a>"]

    earth_and_sky_bargain["<a class='internal-link' href='#Earth and Sky Bargain'>Earth and Sky Bargain</a>"]
...
instantly and permanently to the Underworld.
...
itself to the Sidereal Exalted's soul and vanishes.
...
spirit she finds. The matter is in Saturn's hands.
...
ends when she stops committing Essence to it.
