...
flowchart TD
    ...
    auspicious_prospects_for_caste["<a class='internal-link' href='#Auspicious Prospects for (Caste)'>Auspicious Prospects for (Caste)</a>"]

    marvelous_inclusion_of_details["<a class='internal-link' href='#Marvelous Inclusion of Details'>Marvelous Inclusion of Details</a>"]

    efficient_secretary_technique["<a class='internal-link' href='#Efficient Secretary Technique'>Efficient Secretary Technique</a>"]

    research_assistant_invocation["<a class='internal-link' href='#Research Assistant Invocation'>Research Assistant Invocation</a>"]
    efficient_secretary_technique --> research_assistant_invocation

    embracing_live_method["<a class='internal-link' href='#Embracing Live Method'>Embracing Live Method</a>"]
